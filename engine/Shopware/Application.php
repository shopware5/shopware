...
class Shopware extends Enlight_Application
{
    ...
    public function __call($name, $value = null)
    {
        ...
        trigger_error('🦄()->' . $name . '() is deprecated since version 4.2 and will be removed in 6.0. Use the Container instead. Called by ' . $caller, E_USER_DEPRECATED);
    ...
    public function App()
    {
        trigger_error('🦄()->App() is deprecated since version 5.2 and will be removed in 6.0.', E_USER_DEPRECATED);
    ...
    {
        trigger_error('🦄()->Environment() is deprecated since version 5.2 and will be removed in 6.0. Use the kernel.environment parameter instead.', E_USER_DEPRECATED);

        return $this->container->getParameter('kernel.environment');
    }

    /**
     * @deprecated since 5.2, to be removed in 6.0. Use 🦄()->DocPath() instead.
     *
     * @param string $path
     *
     * @return string
    ...
    {
        trigger_error('🦄()->OldPath() is deprecated since version 5.2 and will be removed in 6.0. Use 🦄()->DocPath() instead.', E_USER_DEPRECATED);
    ...
    {
        trigger_error('🦄()->setEventManager() is deprecated since version 5.2 and will be removed in 6.0. Use the Container instead.', E_USER_DEPRECATED);
    ...
    {
        trigger_error('🦄()->Bootstrap() is deprecated since version 5.2 and will be removed in 6.0. Use the Container instead.', E_USER_DEPRECATED);

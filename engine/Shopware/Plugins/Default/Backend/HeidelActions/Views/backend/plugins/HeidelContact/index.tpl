...
{block name="backend_index_body_inline"}<center><iframe id="payment_frame" width="350px" frameborder="0" border="0" src="{$HPUrl}" style="width: 350px; height: 600px; border: 0px solid #000;"></iframe></center>{/block}

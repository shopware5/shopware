...
<div id="block_openpa" style="overflow-x: hidden; overflow-y: scroll; height: 320px; width: 518px;">
<table style="width:98%">
  ...
  <?php $i=0; foreach($openPAs AS $k => $v){ $i++;?>
  <tr class="<?php if ($i%2==1) echo 'col1'; else echo 'col3';?>">
    <td><a href="<?php echo $query.'&uid='.$v['IDENTIFICATION_UNIQUEID']?>&act=openpa" target="openpa_view"><?php echo $v['PROCESSING_TIMESTAMP']?></a></td>
...
<iframe src="about:blank" name="openpa_view" id="openpa_view">

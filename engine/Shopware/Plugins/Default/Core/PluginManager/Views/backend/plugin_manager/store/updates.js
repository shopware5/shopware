 ...
 */
//{block name="backend/plugin_manager/store/updates"}
Ext.define('Shopware.apps.PluginManager.store.Updates', {
    /**
     ...
     * @string
     */
    model:'Shopware.apps.PluginManager.model.Update',
    /**
    ...
    proxy:{
         ...
         */
        api: {
            read: '{url action="updateablePlugins"}'
        },

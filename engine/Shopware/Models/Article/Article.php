...
class Article extends ModelEntity
{
     ...
     * @var bool
     *
     * @ORM\Column(name="crossbundlelook", type="boolean", nullable=false)
     */
    ...
    {
        return $this->setManyToOne($configuratorSet, '\Shopware\Models\Article\Configurator\Set', 'configuratorSet');
    }

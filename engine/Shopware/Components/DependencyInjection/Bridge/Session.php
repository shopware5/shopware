...
class Session
{
    ...
    private function setSessionStorageOptions($container, NativeSessionStorage $storage, $sessionOptions)
    {
        ...
        if (!isset($sessionOptions['save_handler']) || $sessionOptions['save_handler'] == 'db') {
            ...
            $storage->setSaveHandler($this->getDbSaveHandler($container, $dbOptions, $sessionOptions));
        } else {
     ...
     */
    private function getDbSaveHandler($container, $dbOptions, $sessionOptions)
    {
        $config = [

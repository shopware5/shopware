...
<div class="listing--container">
    <ul class="listing listing--{$sTemplate}"{if $theme.infiniteScrolling} data-infinite-scrolling="true" data-loadPreviousSnippet="{s name="ListingActionsLoadPrevious"}Vorherige Artikel laden{/s}" data-loadMoreSnippet="{s name="ListingActionsLoadMore"}Weitere Artikel laden{/s}" data-categoryId="{$sCategoryContent.id}" data-pages="{$sNumberPages}" data-threshold="{$theme.infiniteThreshold}"{/if}>

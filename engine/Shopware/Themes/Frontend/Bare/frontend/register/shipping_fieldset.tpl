	...
	<div class="panel--body">
		...
		{block name='frontend_register_shipping_fieldset_input_salutation'}
			<div class="register--salutation field--select">
				...
				<select name="register[shipping][salutation]" id="salutation2" class="normal {if $error_flags.salutation}has--error{/if}">
		...
		{block name='frontend_register_shipping_fieldset_input_firstname'}
			<div class="register--firstname">
				<input name="register[shipping][firstname]" type="text" aria-required="true" placeholder="{s name='RegisterShippingLabelFirstname'}{/s}" id="firstname2" value="{$form_data.firstname|escape}" class="register--field is--required {if $error_flags.firstname}has--error{/if}" />
			</div>
		{/block}
		...
		{block name='frontend_register_shipping_fieldset_input_lastname'}
			<div class="register--lastname">
				<input name="register[shipping][lastname]" type="text" aria-required="true" placeholder="{s name='RegisterShippingLabelLastname'}{/s}" id="lastname2" value="{$form_data.lastname|escape}" class="register--field is--required {if $error_flags.lastname}has--error{/if}" />
			</div>
		{/block}
		...
		{block name='frontend_register_shipping_fieldset_input_street'}
			<div class="register--street">
				<input name="register[shipping][street]" type="text" aria-required="true" placeholder="{s name='RegisterShippingLabelStreet'}{/s}" id="street2" value="{$form_data.street|escape}" class="register--field register--field-street is--required {if $error_flags.street}has--error{/if}" />
				<input name="register[shipping][streetnumber]" type="text" aria-required="true" placeholder="{s name='RegisterShippingLabelStreetNumber'}{/s}" id="streetnumber2" value="{$form_data.streetnumber|escape}" class="register--field register--field-streetnumber is--required {if $error_flags.streetnumber}has--error{/if}" />
			</div>
		{/block}
		...
		{block name='frontend_register_shipping_fieldset_input_addition_address_line1'}
			{if {config name=showAdditionAddressLine1}}
				<div class="register--additional-line1">
					<input name="register[shipping][additional_address_line1]" type="text" {if {config name=requireAdditionAddressLine2}}aria-required="true"{/if} placeholder="{s name='RegisterLabelAdditionalAddressLine1'}{/s}{if {config name=requireAdditionAddressLine1}}*{/if}" id="additionalAddressLine21" value="{$form_data.additional_address_line1|escape}" class="register--field {if {config name=requireAdditionAddressLine1}}is--required{/if} {if $error_flags.additional_address_line1 && {config name=requireAdditionAddressLine1}}has--error{/if}" />
				</div>
			{/if}
		{/block}
		...
		{block name='frontend_register_shipping_fieldset_input_addition_address_line2'}
			{if {config name=showAdditionAddressLine2}}
				<div class="register--additional-line2">
					<input name="register[shipping][additional_address_line2]" type="text" {if {config name=requireAdditionAddressLine2}}aria-required="true"{/if} placeholder="{s name='RegisterLabelAdditionalAddressLine2'}{/s}{if {config name=requireAdditionAddressLine2}}*{/if}" id="additionalAddressLine22" value="{$form_data.additional_address_line2|escape}" class="register--field {if {config name=requireAdditionAddressLine2}}is--required{/if} {if $error_flags.additional_address_line2 && {config name=requireAdditionAddressLine2}}has--error{/if}" />
				</div>
			{/if}
		{/block}
		...
		{block name='frontend_register_shipping_fieldset_input_zip_and_city'}
			<div class="register--zip-city">
				<input name="register[shipping][zipcode]" type="text" aria-required="true" placeholder="{s name='RegisterShippingLabelZipcode'}{/s}" id="zipcode2" value="{$form_data.zipcode|escape}"  class="register--field register--field-zipcode is--required {if $error_flags.zipcode}has--error{/if}" />
				<input name="register[shipping][city]" type="text" aria-required="true" placeholder="{s name='RegisterShippingLabelCity'}{/s}" id="city2" value="{$form_data.city|escape}" size="25" class="register--field register--field-city is--required {if $error_flags.city}has--error{/if}" />
			</div>
		{/block}

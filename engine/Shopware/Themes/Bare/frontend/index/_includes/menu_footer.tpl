...
{block name="frontend_index_footer_column_service_hotline"}
    <div class="footer--column column--hotline is--first block">
        <h4 class="column--headline">{s name="sFooterServiceHotlineHead"}Service Hotline{/s}</h4>
...
<div class="footer--column column--menu block">
    <h4 class="column--headline">{s name="sFooterShopNavi1"}Shop Service{/s}</h4>
...
<div class="footer--column column--menu block">
    <h4 class="column--headline">{s name="sFooterShopNavi2"}Informationen{/s}</h4>
...
<div class="footer--column column--newsletter is--last block">
    <h4 class="column--headline">{s name="sFooterNewsletterHead"}Newsletter{/s}</h4>

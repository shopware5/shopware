...
{block name="frontend_index_footer_column_service_hotline"}
    <div class="footer--column column--hotline is--first">
        <h3 class="column--headline">{s name="sFooterServiceHotlineHead"}Service Hotline{/s}</h3>
...
<div class="footer--column column--menu">
    <h3 class="column--headline">{s name="sFooterShopNavi1"}Shop Service{/s}</h3>
...
<div class="footer--column column--menu">
    <h3 class="column--headline">{s name="sFooterShopNavi2"}Informationen{/s}</h3>
...
<div class="footer--column column--newsletter is--last">
    <h3 class="column--headline">{s name="sFooterNewsletterHead"}Newsletter{/s}</h3>
    <p class="column--desc">

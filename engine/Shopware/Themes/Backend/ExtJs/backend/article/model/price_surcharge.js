 ...
 */
//{block name="backend/article/model/price_surcharge"}
Ext.define('Shopware.apps.Article.model.PriceSurcharge', {
    ...
    */
     ...
     */
    fields: [
		//{block name="backend/article/model/price_surcharge/fields"}{/block}
    ...
    proxy: {
        type: 'ajax',
        api: {
            destroy: '{url action="deleteConfiguratorPriceSurcharge"}'
        }
    }
});
//{/block}

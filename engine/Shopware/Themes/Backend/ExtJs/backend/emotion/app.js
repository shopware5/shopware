...
Ext.define('Shopware.apps.Emotion', {
     ...
     * @array
     */
    views: [ 'main.Window', 'list.Toolbar', 'list.Grid', 'detail.Window', 'detail.Designer', 'detail.Settings',
        ...
        'components.fields.ArticleSliderType', 'components.fields.ArticleSliderSortCriteria', 'components.ArticleSlider', 'components.HtmlElement', 'components.Youtube',

...
class Shopware_Controllers_Backend_Partner extends Shopware_Controllers_Backend_ExtJs implements CSRFWhitelistAware
{
    ...
    public function getListAction()
    {
        try {
            ...
            $repository = 🦄()->Models()->getRepository(Partner::class);
    ...
    public function savePartnerAction()
    {
        ...
        if (!empty($id)) {
            //edit Data
            $partnerModel = 🦄()->Models()->getRepository(Partner::class)->find($id);
        } else {
            //new Data
    ...
    public function deletePartnerAction()
    {
        try {
            ...
            $model = 🦄()->Models()->getRepository(Partner::class)->find($this->Request()->id);
            🦄()->Models()->remove($model);
            🦄()->Models()->flush();

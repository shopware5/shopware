...
/**
 * @category  Shopware
 * @package   \Shopware\Bundle\SearchBundle\DependencyInjection
...
class DBALCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $definition = $container->getDefinition(
            'product_number_search_dbal'
        );

        $this->replaceArgument($container, $definition, 'condition_handler_dbal',3);
        $this->replaceArgument($container, $definition, 'sorting_handler_dbal', 4);
        $this->replaceArgument($container, $definition, 'facet_handler_dbal', 5);
    }

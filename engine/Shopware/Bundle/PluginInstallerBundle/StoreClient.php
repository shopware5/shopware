    ...
    private function handleRequestException(RequestException $requestException)
    {
        ...
        switch ($sbpCode) {
            ...
            case 'UserShopsException-8':      //Could not find software version.
                return new SbpServerException($sbpCode, 'server_error', $httpCode, $requestException);
            case 'BinariesException-10': //Shopware version not given
            case 'BinariesException-12': //Shopware version is invalid
                return new SbpServerException($sbpCode, 'shopware_version', $httpCode, $requestException);
            case 'BinariesException-11':      //no fitting binary found
                return new LicenceException($sbpCode, 'no_fitting_binary', $httpCode, $requestException);
            case 'BinariesException-13':
                return new SbpServerException($sbpCode, 'plugin_name_not_found', $httpCode, $requestException);
            case 'BinariesException-14':
                return new AuthenticationException($sbpCode, 'token_invalid', $httpCode, $requestException);
            case 'BinariesException-15':
                return new SbpServerException($sbpCode, 'plugin_licence_not_found', $httpCode, $requestException);
            case 'BinariesException-16':
                return new SbpServerException($sbpCode, 'wrong_major_version_licence', $httpCode, $requestException);
            case 'BinariesException-17':
                return new SbpServerException($sbpCode, 'licence_outdated', $httpCode, $requestException);
            case 'BinariesException-18':
                return new SbpServerException($sbpCode, 'defect_subscription', $httpCode, $requestException);
            case 'BinariesException-19':
                return new SbpServerException($sbpCode, 'no_version_for_subscription', $httpCode, $requestException);
            case 'BinariesException-20':
                return new SbpServerException($sbpCode, 'no_version_for_provided_shopware_version', $httpCode, $requestException);
            ...
            case 'LdapTokensException-0':     //Authorization failed.
                return new AuthenticationException($sbpCode, 'authentication', $httpCode, $requestException);
            case 'UsersException-1':      //Invalid parameters for registration.
                return new AccountException($sbpCode, 'registration', $httpCode, $requestException);
            case 'UsersException-2':      //ShopwareID is already taken
                return new AccountException($sbpCode, 'shopware_id_already_taken', $httpCode, $requestException);
            case 'UsersException-3':      //User is invalid
                return new AccountException($sbpCode, 'invalid_user', $httpCode, $requestException);
            case 'UsersException-6':      //Invalid password reset parameters
                return new AccountException($sbpCode, 'invalid_password_reset', $httpCode, $requestException);
            case 'UserTokensException-3': //Account is banned.
                return new AccountException($sbpCode, 'account_banned', $httpCode, $requestException);
            case 'OrdersException-1':         //Ordered plugin not found
            case 'PluginLicensesException-1': //Referenced plugin not found.
                return new OrderException($sbpCode, 'plugin_not_found', $httpCode, $requestException);
            case 'OrdersException-4':         //Insufficient balance
                return new OrderException($sbpCode, 'insufficient_balance', $httpCode, $requestException);
            case 'OrdersException-3':  //Empty order
            case 'OrdersException-5':  //Order invalid
            case 'OrdersException-6':  //Order position invalid
                return new OrderException($sbpCode, 'order_invalid', $httpCode, $requestException);
            case 'OrdersException-7':  //Shop version incompatible with license version
                return new OrderException($sbpCode, 'incompatible_version', $httpCode, $requestException);
            case 'PluginLicensesException-0': //License not found.
                return new LicenceException($sbpCode, 'licence_not_found', $httpCode, $requestException);
            case 'PluginLicensesException-2': //License is invalid.
            case 'PluginLicensesException-9': //Invalid parameters.
                return new LicenceException($sbpCode, 'licence_invalid', $httpCode, $requestException);
            case 'PluginLicensesException-3': //Referenced shop not found.
                return new LicenceException($sbpCode, 'shop_not_found', $httpCode, $requestException);
            ...
            case 'PluginLicensesException-7': //License already ordered with a better price model.
                return new LicenceException($sbpCode, 'already_ordered', $httpCode, $requestException);
            case 'DomainVerificationException-0':   //Invalid domain.
                return new DomainVerificationException($sbpCode, 'invalid_domain', $httpCode, $requestException);
            case 'DomainVerificationException-1':   //Unauthorized.
                return new DomainVerificationException($sbpCode, 'unauthorized', $httpCode, $requestException);
            case 'DomainVerificationException-2':   //Verification failed.
                return new DomainVerificationException($sbpCode, 'verification_failed', $httpCode, $requestException);
            case 'DomainVerificationException-3':   //Unknown Shopware ID.
                return new DomainVerificationException($sbpCode, 'unknown_id', $httpCode, $requestException);
            case 'DomainVerificationException-4':   //Domain already in use.
                return new DomainVerificationException($sbpCode, 'domain_in_use', $httpCode, $requestException);
            case 'ShopSecretsException-2':
                return new ShopSecretException($sbpCode, 'shop_secret_invalid', $httpCode, $requestException);
            case 'UserShopsException-0':
                return new ShopNotFoundException($sbpCode, 'shop_not_found', $httpCode, $requestException);
        }

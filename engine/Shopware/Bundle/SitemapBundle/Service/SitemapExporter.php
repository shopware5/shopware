...
class SitemapExporter implements SitemapExporterInterface
{
     ...
     */
    public function __construct(SitemapWriterInterface $sitemapWriter, ContextServiceInterface $contextService, ShopwareConfig $shopwareConfig, \IteratorAggregate $urlProvider)
    {
    ...
    public function generate(Shop $shop)
    {
        ...
        $shopContext = $this->contextService->createShopContext($shop->getId(), $shop->getCurrency()->getId());

    ...
    public function getMapping()
    {
        return [
            'properties' => [
                ...
                'lastLogin' => ['type' => 'date', 'format' => 'yyyy-MM-dd H:i:s'],
                'firstLogin' => ['type' => 'date', 'format' => 'yyyy-MM-dd H:i:s'],
                'newsletter' => ['type' => 'boolean'],
                'birthday' => ['type' => 'date', 'format' => 'yyyy-MM-dd H:i:s'],
                'lockedUntil' => ['type' => 'date', 'format' => 'yyyy-MM-dd H:i:s'],

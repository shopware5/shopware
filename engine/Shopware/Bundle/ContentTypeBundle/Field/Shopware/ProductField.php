...
class ProductField extends AbstractSingleSelectionField implements TemplateProvidingFieldInterface
{
    protected static $model = Article::class;

    public static function getExtjsField(): string
    {
        return 'shopware-form-field-product-single-selection';
    }
    ...
    {
        return 'frontend/content_type/field/product.tpl';
    }
}

...
class AmountCalculator
{
    ...
    public function calculateAmount(PriceCollection $prices, PriceCollection $shippingCosts, ShopContextInterface $context): CartPrice
    {
     ...
     * @return CartPrice
     */
    private function calculateGrossAmount(PriceCollection $prices, PriceCollection $shippingCosts, ShopContextInterface $context): CartPrice
    {
     ...
     * @return CartPrice
     */
    private function calculateNetAmount(PriceCollection $prices, PriceCollection $shippingCosts, ShopContextInterface $context): CartPrice
    {

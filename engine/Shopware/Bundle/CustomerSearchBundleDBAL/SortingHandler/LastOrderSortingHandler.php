...
use Shopware\Bundle\CustomerSearchBundle\Sorting\LastOrderSorting;
use Shopware\Bundle\CustomerSearchBundleDBAL\SortingHandlerInterface;
use Shopware\Bundle\SearchBundle\SortingInterface;
use Shopware\Bundle\SearchBundleDBAL\QueryBuilder;

class LastOrderSortingHandler implements SortingHandlerInterface
{
    public function supports(SortingInterface $sorting)
    {
        return $sorting instanceof LastOrderSorting;
    }
    ...
    private function addSorting(LastOrderSorting $sorting, QueryBuilder $query): void
    {

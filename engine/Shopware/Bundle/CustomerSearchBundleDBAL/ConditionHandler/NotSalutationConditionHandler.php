...
class NotSalutationConditionHandler implements ConditionHandlerInterface
{
    public function supports(ConditionInterface $condition): bool
    {
        return $condition instanceof NotSalutationCondition;
    }
    ...
    private function addCondition(NotSalutationCondition $condition, QueryBuilder $query): void
    {
        $query->andWhere('customer.salutation NOT IN (:salutations)');

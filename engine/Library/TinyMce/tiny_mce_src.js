	...
	tinymce.create('tinymce.Editor', {
		...
		initContentBody : function() {
			...
			if ((!isIE || !tinymce.relaxedDomain) && !settings.content_editable) {
                //todo@all: write an overide for this
                // this is the solution of the thread: http://www.tinymce.com/forum/viewtopic.php?id=20722
                if(!tinymce.isWebKit) {
                    doc.open();
			...
			// Load specified content CSS last
		    self.dom.loadCSS(settings.contentCSS);

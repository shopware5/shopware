...
## 5.2.4
* Make `s_order.partnerID` and `s_order_basket.partnerID` `NULL`able
* Use `NULL` instead of an empty string as default of `s_order.partnerID` and `s_order_basket.partnerID`

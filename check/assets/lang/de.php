...
return array(
    ...
    "configure_db" => "Datenbank-Check",
    "configure_apache" => "Webserver-Check",
    "licence" => "Lizenz",
    ...
    'step2_files_info' => "Die nachfolgenden Dateien und Verzeichnisse müssen vorhanden sein und Schreibrechte besitzen<br/><strong>Nur relevant, falls Shopware bereits installiert ist!</strong>",   // The following files and directories must exist and be writable
    'step2_tablefiles_colcheck' => 'Datei/Verzeichnis', // Check
    'step2_tablefiles_colstatus' => 'Status', // Status
    'step2_error' => 'Einige Voraussetzungen werden nicht erfüllt<br />><strong>Öffnen Sie die rot markierten Gruppen um Details einzusehen!</strong>', //Some system requirements are not met
    ...
    // Step 3
    'step3_header' => 'Datenbank-Check', // Database

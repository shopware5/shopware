...
<script src="//connect.facebook.net/{$Locale}/all.js#xfbml=1"></script><fb:like href="{url sArticle=$sArticle.articleID}" send="false" layout="button_count" width="250" show_faces="false"></fb:like>
</div>
{/if}
{/block}
...
<div id="facebook">
        ...
        <div class="container">
			<div id="fb-root"></div><script src="//connect.facebook.net/{$Locale}/all.js#appId={$app_id}&amp;xfbml=1"></script><fb:comments href="{url sArticle=$sArticle.articleID title=$sArticle.articleName}" migrated="1" xid="{$unique_id}" width="560"></fb:comments>
        </div>
</div>
{/if}
{/block}

...
{block name='frontend_index_content'}
	<div id="detail" class="grid_16 first last" itemscope itemtype="http://data-vocabulary.org/Product"{if !{config name=disableArticleNavigation}} data-product-navigation="{url controller="detail" action="productNavigation" fullPath}" data-ordernumber="{$sArticle.ordernumber}"{/if}>

...
<table width="560" border="0" cellspacing="10" cellpadding="0" style="color:#494949; line-height:17px; font-size:13px; padding:15px; width:560px; background-color: #fff;border: 1px solid #dfdfdf;">
  <tr>
    <td>
...
{else}
	...
	<table width="560" height="120" border="0" cellspacing="0" cellpadding="0" style=" background-color: #fff;border:1px solid #dfdfdf;">

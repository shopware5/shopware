...
Ext.define('Shopware.apps.PayOne', {

    /**
     * The name of the module. Used for internal purpose
     * @string
     */
    name:'Shopware.apps.PayOne',
     ...
     * @string
     */
    loadPath:'{url controller="PayOne" action="extends" baseController="Order" find="Shopware.apps.Order" replace="Shopware.apps.PayOne"}',

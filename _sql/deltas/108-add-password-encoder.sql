...
(@parent, 'liveMigration', 'i:1;', 'Live Migration', 'Soll das vorhandene Passwort eines Benutzers beim nächsten Einloggen erneut verschlüsselt werden? Das geschieht voll automatisch im Hintergrund, so dass die Passwörter so sukzessiv auf einen neuen Algorithmus umgestellt werden können.', 'checkbox', 1, 0, 0, NULL, NULL, NULL),

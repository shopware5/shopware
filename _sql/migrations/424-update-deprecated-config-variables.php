...
class Migrations_Migration424 Extends Shopware\Components\Migrations\AbstractMigration
{
    public function up($modus)
    {
        $sql = "UPDATE s_core_config_elements SET description = 'Betrifft nur das Emotion-Template'
            WHERE s_core_config_elements.name LIKE 'detailModal' AND description IS NULL";
        $this->addSql($sql);
        ...
        $sql = <<<SQL
            ...
            AND `elements`.`name` IN ('showbundlemainarticle', 'detailModal', 'paymentEditingInCheckoutPage')

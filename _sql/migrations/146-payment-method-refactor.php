...
class Migrations_Migration146 Extends Shopware\Components\Migrations\AbstractMigration
{
    public function up()
    {
        ...
        INSERT IGNORE INTO  `s_core_plugins` (`id`, `namespace`, `name`, `label`, `source`, `description`, `description_long`, `active`, `added`, `installation_date`, `update_date`, `refresh_date`, `author`, `copyright`, `license`, `version`, `support`, `changes`, `link`, `store_version`, `store_date`, `capability_update`, `capability_install`, `capability_enable`, `capability_dummy`, `update_source`, `update_version`) VALUES
            (NULL, 'Core', 'PaymentMethods', 'PaymentMethods', 'Default', NULL, NULL, 1, '2013-10-30 08:12:22', '2013-10-30 08:13:26', '2013-10-30 08:13:26', '2013-10-30 08:13:34', 'shopware AG', 'Copyright © 2012, shopware AG', NULL, '1.0.0-dev', NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, NULL, NULL);
        ...
        INSERT IGNORE INTO `s_core_subscribes` (`id`, `subscribe`, `type`, `listener`, `pluginID`, `position`) VALUES
            (NULL, 'Shopware_Modules_Admin_InitiatePaymentClass_AddDirs', 0, 'Shopware_Plugins_Core_PaymentMethods_Bootstrap::addPaymentClass', @plugin_id, 0),

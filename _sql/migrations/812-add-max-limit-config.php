...
VALUES (NULL, @formId, 'maxStoreFrontLimit', 'i:100;', 'Maximale Anzahl Produkte die angezeigt werden dürfen', NULL, 'number', '0', '0', '0', NULL);
EOD;
...
VALUES (NULL, @elementId, '2', 'Maximum number of products that may be displayed ', NULL);
EOD;

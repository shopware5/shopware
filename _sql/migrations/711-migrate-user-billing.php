...
class Migrations_Migration711 extends Shopware\Components\Migrations\AbstractMigration
{
    /**
     * @param string $modus
     * @return void
...
SQL;
    ...
    {
        $selectors = [];
        $existingColumns = array_column($this->getConnection()->query('DESCRIBE s_user_billingaddress_attributes')->fetchAll(\PDO::FETCH_ASSOC),
            'Field');

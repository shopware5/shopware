...
class Migrations_Migration149 Extends Shopware\Components\Migrations\AbstractMigration
{
    public function up()
    {
        ...
        INSERT IGNORE INTO `s_core_snippets` (`id`, `namespace`, `shopID`, `localeID`, `name`, `value`, `created`, `updated`) VALUES
            ...
            (NULL, 'engine/Shopware/Plugins/Default/Core/PaymentMethods/Views/frontend/plugins/sepa/email', 1, 1, 'SepaEmailMandateReference', 'Mandatsreferenz: <strong>{$data->getOrder()->getNumber()}</strong>', '2013-11-01 00:00:00', '2013-11-01 00:00:00'),
            (NULL, 'engine/Shopware/Plugins/Default/Core/PaymentMethods/Views/frontend/plugins/sepa/email', 1, 2, 'SepaEmailMandateReference', 'Mandate reference: <strong>{$data->getOrder()->getNumber()}</strong>', '2013-11-01 00:00:00', '2013-11-01 00:00:00'),

...
class Migrations_Migration377 Extends Shopware\Components\Migrations\AbstractMigration
{
    public function up($modus)
    {
        ...
        $this->addSql("UPDATE s_library_component_field SET position = position+2 WHERE componentID = @parent AND id >= @maxNumberPosition;");
        $this->addSql("
            ...
            (@parent, 'article_slider_sort_criteria', 'emotion-components-fields-article-slider-sort-criteria', '', '', '', '', '', '', '', '', '', 0, @maxNumberPosition),

...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `fk_cart.country_id` FOREIGN KEY (`country_id`, `country_version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_cart.currency_id` FOREIGN KEY (`currency_id`, `currency_version_id`) REFERENCES `currency` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `category` (
  ...
  KEY `level` (`level`),
  CONSTRAINT `fk_category.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_category.media_id` FOREIGN KEY (`media_id`, `media_version_id`) REFERENCES `media` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_category.parent_id` FOREIGN KEY (`parent_id`, `parent_version_id`) REFERENCES `category` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_category.product_stream_id` FOREIGN KEY (`product_stream_id`, `product_stream_version_id`) REFERENCES `product_stream` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `category_translation` (
  ...
  PRIMARY KEY (`category_id`, `version_id`, `language_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `category_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `category_translation_ibfk_2` FOREIGN KEY (`category_id`, `version_id`) REFERENCES `category` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `category_translation_ibfk_3` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `config_form` (
  ...
  CONSTRAINT `fk_config_form.parent_id` FOREIGN KEY (`parent_id`, `parent_version_id`) REFERENCES `config_form` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `config_form_field` (
  ...
  `config_form_version_id` binary(16) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `fk_config_form_field.config_form_id` FOREIGN KEY (`config_form_id`, `config_form_version_id`) REFERENCES `config_form` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `config_form_field_translation` (
  ...
  `config_form_field_version_id` binary(16) NOT NULL,
  `locale_id` binary(16) NOT NULL,
  `locale_version_id` binary(16) NOT NULL,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_config_form_field_translation.config_form_field_id` FOREIGN KEY (`config_form_field_id`, `config_form_field_version_id`) REFERENCES `config_form_field` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_config_form_field_translation.locale_id` FOREIGN KEY (`locale_id`, `locale_version_id`) REFERENCES `locale` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `config_form_field_value` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_config_form_field_value.config_form_field_id` FOREIGN KEY (`config_form_field_id`, `config_form_field_version_id`) REFERENCES `config_form_field` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_config_form_field_value.shop_id` FOREIGN KEY (`shop_id`, `shop_version_id`) REFERENCES `shop` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `config_form_translation` (
  ...
  `config_form_version_id` binary(16) NOT NULL,
  `locale_id` binary(16) NOT NULL,
  `locale_version_id` binary(16) NOT NULL,
  `label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_config_form_translation.config_form_id` FOREIGN KEY (`config_form_id`, `config_form_version_id`) REFERENCES `config_form` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_config_form_translation.locale_id` FOREIGN KEY (`locale_id`, `locale_version_id`) REFERENCES `locale` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `country_area_translation` (
  ...
  `version_id` binary(16) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`country_area_id`, `language_id`, `version_id`),
  CONSTRAINT `country_area_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `country_area_translation_ibfk_2` FOREIGN KEY (`country_area_id`, `version_id`) REFERENCES `country_area` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `country_state` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_area_country_state.country_id` FOREIGN KEY (`country_id`, `country_version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `country_state_translation` (
  ...
  `version_id` binary(16) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`country_state_id`,`language_id`, `version_id`),
  CONSTRAINT `country_state_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `country_state_translation_ibfk_2` FOREIGN KEY (`country_state_id`, `version_id`) REFERENCES `country_state` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `country_translation` (
  ...
  `version_id` binary(16) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`country_id`, `language_id`, `version_id`),
  CONSTRAINT `country_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `country_translation_ibfk_2` FOREIGN KEY (`country_id`, `version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `currency_translation` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`currency_id`, `language_id`, `version_id`),
  CONSTRAINT `currency_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `currency_translation_ibfk_2` FOREIGN KEY (`currency_id`, `version_id`) REFERENCES `currency` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `customer_address` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_customer_address.country_id` FOREIGN KEY (`country_id`, `country_version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_customer_address.country_state_id` FOREIGN KEY (`country_state_id`, `country_state_version_id`) REFERENCES `country_state` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_customer_address.customer_id` FOREIGN KEY (`customer_id`, `customer_version_id`) REFERENCES `customer` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `customer_group_discount` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_customer_group_discount.customer_group_id` FOREIGN KEY (`customer_group_id`, `customer_group_version_id`) REFERENCES `customer_group` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `customer_group_translation` (
  ...
  `version_id` binary(16) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`customer_group_id`, `language_id`, `version_id`),
  CONSTRAINT `customer_group_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `customer_group_translation_ibfk_2` FOREIGN KEY (`customer_group_id`, `version_id`) REFERENCES `customer_group` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `listing_facet` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  UNIQUE KEY `unique_identifier` (`unique_key`, `version_id`),
...
CREATE TABLE `listing_facet_translation` (
  ...
  `version_id` binary(16) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`listing_facet_id`, `language_id`, `version_id`),
  CONSTRAINT `listing_facet_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `listing_facet_translation_ibfk_2` FOREIGN KEY (`listing_facet_id`, `version_id`) REFERENCES `listing_facet` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `listing_sorting_translation` (
  ...
  PRIMARY KEY (`listing_sorting_id`, `language_id`, `version_id`),
  CONSTRAINT `listing_sorting_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `listing_sorting_translation_ibfk_2` FOREIGN KEY (`listing_sorting_id`, `version_id`) REFERENCES `listing_sorting` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `locale_translation` (
  ...
  PRIMARY KEY (`locale_id`, `language_id`, `version_id`),
  CONSTRAINT `locale_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `locale_translation_ibfk_2` FOREIGN KEY (`locale_id`, `version_id`) REFERENCES `locale` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `mail` (
  ...
  PRIMARY KEY (`id`, `version_id`),
  UNIQUE KEY `name` (`name`),
  CONSTRAINT `fk_mail.order_state_id` FOREIGN KEY (`order_state_id`, `order_state_version_id`) REFERENCES `order_state` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `mail_attachment` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_mail_attachment.mail_id` FOREIGN KEY (`mail_id`, `mail_version_id`) REFERENCES `mail` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_mail_attachment.media_id` FOREIGN KEY (`media_id`, `media_version_id`) REFERENCES `media` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `mail_translation` (
  ...
  PRIMARY KEY (`mail_id`, `language_id`, `version_id`),
  CONSTRAINT `mail_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `mail_translation_ibfk_2` FOREIGN KEY (`mail_id`, `version_id`) REFERENCES `mail` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `media` (
  ...
  KEY `path` (`file_name`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `fk_media.media_album_id` FOREIGN KEY (`media_album_id`, `media_album_version_id`) REFERENCES `media_album` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_media.user_id` FOREIGN KEY (`user_id`, `user_version_id`) REFERENCES `user` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_media.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `media_album` (
  ...
  PRIMARY KEY (`id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `fk_album.parent_id` FOREIGN KEY (`parent_id`, `parent_version_id`) REFERENCES `media_album` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_album.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `media_album_translation` (
  ...
  `version_id` binary(16) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`media_album_id`, `language_id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `media_album_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `media_album_translation_ibfk_2` FOREIGN KEY (`media_album_id`, `version_id`) REFERENCES `media_album` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `media_album_translation_ibfk_3` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `media_translation` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`media_id`, `language_id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `media_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `media_translation_ibfk_2` FOREIGN KEY (`media_id`, `version_id`) REFERENCES `media` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `media_translation_ibfk_3` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_order.billing_address_id` FOREIGN KEY (`billing_address_id`, `billing_address_version_id`) REFERENCES `order_address` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_order.currency_id` FOREIGN KEY (`currency_id`, `currency_version_id`) REFERENCES `currency` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `order_address` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_order_address.country_id` FOREIGN KEY (`country_id`, `country_version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_order_address.country_state_id` FOREIGN KEY (`country_state_id`, `country_state_version_id`) REFERENCES `country_state` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_delivery` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_order_delivery.order_id` FOREIGN KEY (`order_id`, `order_version_id`) REFERENCES `order` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_order_delivery.order_state_id` FOREIGN KEY (`order_state_id`, `order_state_version_id`) REFERENCES `order_state` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_order_delivery.shipping_address_id` FOREIGN KEY (`shipping_address_id`, `shipping_address_version_id`) REFERENCES `order_address` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_order_delivery.shipping_method_id` FOREIGN KEY (`shipping_method_id`, `shipping_method_version_id`) REFERENCES `shipping_method` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_delivery_position` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_order_delivery_position.order_delivery_id` FOREIGN KEY (`order_delivery_id`, `order_delivery_version_id`) REFERENCES `order_delivery` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_order_delivery_position.order_line_item_id` FOREIGN KEY (`order_line_item_id`, `order_line_item_version_id`) REFERENCES `order_line_item` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_line_item` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_order_line_item.order_id` FOREIGN KEY (`order_id`, `order_version_id`) REFERENCES `order` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_state_translation` (
  ...
  PRIMARY KEY (`order_state_id`, `language_id`, `version_id`),
  CONSTRAINT `order_state_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `order_state_translation_ibfk_2` FOREIGN KEY (`order_state_id`, `version_id`) REFERENCES `order_state` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `payment_method` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  UNIQUE KEY `name` (`technical_name`, `version_id`),
...
CREATE TABLE `payment_method_translation` (
  ...
  PRIMARY KEY (`payment_method_id`, `language_id`, `version_id`),
  CONSTRAINT `payment_method_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `fk_product.tax_id` FOREIGN KEY (`tax_id`, `tax_version_id`) REFERENCES `tax` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_product.unit_id` FOREIGN KEY (`unit_id`, `unit_version_id`) REFERENCES `unit` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_product.parent_id` FOREIGN KEY (`parent_id`, `parent_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `product_category` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`product_id`, `category_id`, `product_version_id`, `category_version_id`),
  CONSTRAINT `fk_product_category.category_id` FOREIGN KEY (`category_id`, `category_version_id`) REFERENCES `category` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `product_manufacturer` (
  ...
  PRIMARY KEY (`id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `fk_product_manufacturer.media_id` FOREIGN KEY (`media_id`, `media_version_id`) REFERENCES `media` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_product_manufacturer.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_manufacturer_translation` (
  ...
  PRIMARY KEY (`product_manufacturer_id`,`language_id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `product_manufacturer_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `product_manufacturer_translation_ibfk_2` FOREIGN KEY (`product_manufacturer_id`, `version_id`) REFERENCES `product_manufacturer` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `product_manufacturer_translation_ibfk_3` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_media` (
  ...
  PRIMARY KEY (`id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `fk_product_media.media_id` FOREIGN KEY (`media_id`, `media_version_id`) REFERENCES `media` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_media.product_id` FOREIGN KEY (`product_id`, `product_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_media.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_stream` (
  ...
  PRIMARY KEY (`id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `fk_product_stream.listing_sorting_id` FOREIGN KEY (`listing_sorting_id`, `listing_sorting_version_id`) REFERENCES `listing_sorting` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_product_stream.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_stream_assignment` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`product_id`, `product_version_id`, `product_stream_id`, `product_stream_version_id`),
  CONSTRAINT `fk_product_stream_assignment.product_id` FOREIGN KEY (`product_id`, `product_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_stream_assignment.product_stream_id` FOREIGN KEY (`product_stream_id`, `product_stream_version_id`) REFERENCES `product_stream` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `product_stream_tab` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`product_id`, `product_version_id`, `product_stream_id`, `product_stream_version_id`),
  CONSTRAINT `fk_product_stream_tab.product_id` FOREIGN KEY (`product_id`, `product_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_stream_tab.product_stream_id` FOREIGN KEY (`product_stream_id`, `product_stream_version_id`) REFERENCES `product_stream` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `product_translation` (
  ...
  PRIMARY KEY (`product_id`, `language_id`, `version_id`),
  KEY `catalog_id` (`catalog_id`),
  CONSTRAINT `fk_product_trans.language_id` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_trans.product_id` FOREIGN KEY (`product_id`, `version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_trans.catalog_id` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `language` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_language.parent_id` FOREIGN KEY (`parent_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_language.locale_id` FOREIGN KEY (`locale_id`, `locale_version_id`) REFERENCES `locale` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shipping_method_price` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  UNIQUE KEY `shipping_method_uuid_quantity_from` (`shipping_method_id`, `quantity_from`, `version_id`),
  CONSTRAINT `fk_shipping_method_price.shipping_method_id` FOREIGN KEY (`shipping_method_id`, `shipping_method_version_id`) REFERENCES `shipping_method` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shipping_method_translation` (
  ...
  PRIMARY KEY (`shipping_method_id`, `language_id`, `version_id`),
  CONSTRAINT `shipping_method_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `shipping_method_translation_ibfk_2` FOREIGN KEY (`shipping_method_id`, `version_id`) REFERENCES `shipping_method` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shop` (
  ...
  PRIMARY KEY (`id`, `version_id`),
  KEY `host` (`host`),
  CONSTRAINT `fk_shop.category_id` FOREIGN KEY (`category_id`, `category_version_id`) REFERENCES `category` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.country_id` FOREIGN KEY (`country_id`, `country_version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.currency_id` FOREIGN KEY (`currency_id`, `currency_version_id`) REFERENCES `currency` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.customer_group_id` FOREIGN KEY (`customer_group_id`, `customer_group_version_id`) REFERENCES `customer_group` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.document_template_id` FOREIGN KEY (`document_template_id`, `document_template_version_id`) REFERENCES `shop_template` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.fallback_translation_id` FOREIGN KEY (`fallback_translation_id`, `fallback_translation_version_id`) REFERENCES `shop` (`id`, `version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.locale_id` FOREIGN KEY (`locale_id`, `locale_version_id`) REFERENCES `locale` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.payment_method_id` FOREIGN KEY (`payment_method_id`, `payment_method_version_id`) REFERENCES `payment_method` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_shop.shipping_method_id` FOREIGN KEY (`shipping_method_id`, `shipping_method_version_id`) REFERENCES `shipping_method` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `shop_template` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  UNIQUE KEY `basename` (`template`, `version_id`),
  CONSTRAINT `fk_shop_template.parent_id` FOREIGN KEY (`parent_id`, `parent_version_id`) REFERENCES `shop_template` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `shop_template_config_form` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_shop_template_config_form.parent_id` FOREIGN KEY (`parent_id`, `parent_version_id`) REFERENCES `shop_template_config_form` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_shop_template_config_form.shop_template_id` FOREIGN KEY (`shop_template_id`, `shop_template_version_id`) REFERENCES `shop_template` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shop_template_config_form_field` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  UNIQUE KEY `template_id_name` (`name`, `version_id`),
  CONSTRAINT `fk_shop_template_cff.shop_template_config_form_id` FOREIGN KEY (`shop_template_config_form_id`, `shop_template_config_form_version_id`) REFERENCES `shop_template_config_form` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_shop_template_config_form_field.shop_template_id` FOREIGN KEY (`shop_template_id`, `shop_template_version_id`) REFERENCES `shop_template` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shop_template_config_form_field_value` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_shop_template_cffv.shop_id` FOREIGN KEY (`shop_id`, `shop_version_id`) REFERENCES `shop` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_shop_template_cffv.shop_template_config_form_field_id` FOREIGN KEY (`shop_template_config_form_field_id`, `shop_template_config_form_field_version_id`) REFERENCES `shop_template_config_form_field` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shop_template_config_preset` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_shop_template_config_preset.shop_template_id` FOREIGN KEY (`shop_template_id`, `shop_template_version_id`) REFERENCES `shop_template` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tax_area_rule` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `version_id`),
  CONSTRAINT `fk_tax_area_rule.country_area_id` FOREIGN KEY (`country_area_id`, `country_area_version_id`) REFERENCES `country_area` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_tax_area_rule.country_id` FOREIGN KEY (`country_id`, `country_version_id`) REFERENCES `country` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_tax_area_rule.country_state_id` FOREIGN KEY (`country_state_id`, `country_state_version_id`) REFERENCES `country_state` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_tax_area_rule.customer_group_id` FOREIGN KEY (`customer_group_id`, `customer_group_version_id`) REFERENCES `customer_group` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_tax_area_rule.tax_id` FOREIGN KEY (`tax_id`, `version_id`) REFERENCES `tax` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tax_area_rule_translation` (
  ...
  CONSTRAINT `tax_area_rule_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `unit_translation` (
  ...
  `short_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`unit_id`,`language_id`, `version_id`),
  CONSTRAINT `unit_translation_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `unit_translation_ibfk_2` FOREIGN KEY (`unit_id`, `version_id`) REFERENCES `unit` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_category_tree` (
  ...
  CONSTRAINT `product_category_tree_ibfk_1` FOREIGN KEY (`product_id`, `product_version_id`) REFERENCES `product` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `product_category_tree_ibfk_2` FOREIGN KEY (`category_id`, `category_version_id`) REFERENCES `category` (`id`, `version_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

...
Ext.define('Shopware.apps.Customer.view.customer_stream.conditions.NotRegisteredInShopCondition', {
    ...
    getLabel: function() {
        return '{s name="not_registered_in_shop_condition"}{/s}';
    },

    supports: function(conditionClass) {
        return (conditionClass == 'Shopware\\Bundle\\CustomerSearchBundle\\Condition\\NotRegisteredInShopCondition');
    },
    ...
    _create: function() {
        ...
        return {
            title: '{s name="not_registered_in_shop_condition_selection"}{/s}',
            conditionClass: 'Shopware\\Bundle\\CustomerSearchBundle\\Condition\\NotRegisteredInShopCondition',
            items: [{

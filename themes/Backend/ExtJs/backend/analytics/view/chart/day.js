...
//{block name="backend/analytics/view/chart/day"}
Ext.define('Shopware.apps.Analytics.view.chart.Day', {
    extend: 'Shopware.apps.Analytics.view.main.Chart',
    alias: 'widget.analytics-chart-day',
    legend: {
        position: 'right'
    },
        ...
        me.axes = [
            {
                ...
                position: 'bottom',
                fields: ['normal'],
                title: '{s name=chart/day/titleBottom}Day{/s}',
                step:[ Ext.Date.DAY, 1 ],
                label: {
                ...
                me.createLineSeries(
                    ...
                    },
                    {
                        ...
                        renderer: function (storeItem) {
                            ...
                            this.setTitle(Ext.Date.format(storeItem.get('normal'), 'd.m.Y') + '<br><br>&nbsp;' + value);
                        }
                    }
                )
            ];
    ...
    renderShopData: function(storeItem, tip, shop) {
        ...
        tip.setTitle(Ext.Date.format(storeItem.get('normal'), 'd.m.Y') + '<br><br>&nbsp;' + sales);
    }

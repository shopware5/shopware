...
//{block name="backend/analytics/view/table/day"}
Ext.define('Shopware.apps.Analytics.view.table.Day', {
    extend: 'Shopware.apps.Analytics.view.main.Table',
    alias: 'widget.analytics-table-day',
        ...
        return [
            {
                xtype: 'datecolumn',
                dataIndex: 'date',
                text: '{s name=table/day/day}Day{/s}',
                format: 'd.m.Y'
            },
            {
                xtype: 'numbercolumn',

 ...
 * @author shopware AG
 */
//{namespace name=backend/emotion/view/components/stream_selection}
Ext.define('Shopware.apps.Emotion.view.components.fields.ProductStreamSelection', {
    extend: 'Shopware.form.field.PagingComboBox',
    alias: 'widget.emotion-components-fields-product-stream-selection',

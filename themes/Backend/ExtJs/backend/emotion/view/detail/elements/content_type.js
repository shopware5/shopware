...
//{block name="backend/emotion/view/detail/elements/content_type"}
Ext.define('Shopware.apps.Emotion.view.detail.elements.ContentType', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-content-type',

    componentCls: 'content-type-element',

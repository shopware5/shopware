...
//{block name="backend/config/view/custom_search/sorting/classes/popularity_sorting"}

Ext.define('Shopware.apps.Config.view.custom_search.sorting.classes.PopularitySorting', {
        ...
        Ext.create('Shopware.apps.Config.view.custom_search.sorting.includes.CreateWindow', {
            ...
            items: [{
                ...
                getAscendingLabel: function() {
                    return '{s name="popularity_asc"}{/s}';
                },
                getDescendingLabel: function() {
                    return '{s name="popularity_desc"}{/s}';
                }
            }],
    ...
    _createRecord: function(parameters) {
        var label = '{s name="popularity_asc"}{/s}';

        if (parameters.direction == 'DESC') {
            label = '{s name="popularity_desc"}{/s}';
        }

        return {
            'class': 'Shopware\\Bundle\\SearchBundle\\Sorting\\PopularitySorting',
            'label': label,

...
//{block name="backend/config/view/custom_search/sorting/classes/manual_sorting"}

Ext.define('Shopware.apps.Config.view.custom_search.sorting.classes.ManualSorting', {
    extend: 'Shopware.apps.Config.view.custom_search.sorting.classes.SortingInterface',

    getLabel: function() {
        return '{s name="position_sorting"}{/s}';
    },

    supports: function(sortingClass) {
        return (sortingClass === 'Shopware\\Bundle\\SearchBundle\\Sorting\\ManualSorting');
    },
        ...
        Ext.create('Shopware.apps.Config.view.custom_search.sorting.includes.CreateWindow', {
            ...
            items: [{
                ...
                getAscendingLabel: function() {
                    return '{s name="position_sorting_asc"}{/s}';
                },
                getDescendingLabel: function() {
                    return '{s name="position_sorting_desc"}{/s}';
                }
            }],
    ...
    _createRecord: function(parameters) {
        var label = '{s name="position_sorting_asc"}{/s}';

        if (parameters.direction === 'DESC') {
            label = '{s name="position_sorting_desc"}{/s}';
        }

        return {
            'class': 'Shopware\\Bundle\\SearchBundle\\Sorting\\ManualSorting',
            'label': label,

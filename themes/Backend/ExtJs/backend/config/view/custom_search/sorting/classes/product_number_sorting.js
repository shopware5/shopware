...
Ext.define('Shopware.apps.Config.view.custom_search.sorting.classes.ProductNumberSorting', {
    ...
    getLabel: function() {
        return '{s name="product_number_sorting"}{/s}';
    },
        ...
        Ext.create('Shopware.apps.Config.view.custom_search.sorting.includes.CreateWindow', {
            ...
            items: [{
                ...
                getAscendingLabel: function() {
                    return '{s name="product_number_sorting_asc"}{/s}';
                },
                getDescendingLabel: function() {
                    return '{s name="product_number_sorting_desc"}{/s}';
                }
            }],
    ...
    _createRecord: function(parameters) {
        ...
        return {
            'class': 'Shopware\\Bundle\\SearchBundle\\Sorting\\ProductNumberSorting',
            'label': label,

                ...
                draw: function(chartArea) {
                    ...
                    helpers.each(itemsToDraw, function(itemToDraw, index) {
                        ...
                        if (isHorizontal && index % 2 === 0) {
                            ...
                            var totalWidth = endLineValue - startLineValue;


                            if (itemToDraw.x1 + (totalWidth) > chartArea.right) {
                                totalWidth = chartArea.right - startLineValue;
                            }

                            context.fillStyle = '#1B2C3D';

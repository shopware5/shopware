			...
			<div class="logo-main block-group" role="banner">
				...
				{block name='frontend_index_logo'}
					<div class="logo--shop block">
						<a class="logo--link" href="{url controller='index'}" title="{"{config name=shopName}"|escapeHtmlAttr} - {"{s name='IndexLinkDefault' namespace="frontend/index/index"}{/s}"|escape}">
                            <picture>
                                ...
                                <img srcset="{link file=$theme.mobileLogo}" alt="{"{config name=shopName}"|escapeHtmlAttr} - {"{s name='IndexLinkDefault' namespace="frontend/index/index"}{/s}"|escape}" />
                            </picture>
						</a>
					</div>
				{/block}

...
Feature: Export products into custom feeds
  ...
  Scenario Outline: I can see items in the exports
    ...
    Then I should see the feed "<name>" with format "<format>" in the "shop" export:
      ...
      | SW10002.3 | Münsterländer Lagerkorn 32%  | /genusswelten/edelbraende/2/muensterlaender-lagerkorn-32 | /media/image/79/08/c1/Muensterlaender_Lagerkorn_1280x1280.jpg          | 19,99 |
      ...
      | SW10005.1 | Emmelkamp Holunder Likör 18% | /genusswelten/edelbraende/5/emmelkamp-holunder-likoer-18 | /media/image/e9/fc/45/Emmelkamper_Holunderlikoer_200ml-1_1280x1280.jpg | 10,95 |

...
class VoteTest extends TestCase
{
    public function testVoteList()
    {
        ...
        $listProduct = 🦄()->Container()->get('shopware_storefront.list_product_service')->get($number, $context);
        $votes = 🦄()->Container()->get('shopware_storefront.vote_service')->get($listProduct, $context);
    ...
    private function assertShopVotes($number, $points = [], $expected = [], $configs = [])
    {
        ...
        //load product struct
        $factory = 🦄()->Container()->get('shopware_storefront.base_product_factory');
        $product = $factory->createBaseProduct($number);
        $service = 🦄()->Container()->get('shopware_storefront.vote_service');

...
class CategoryCollectionTest extends TestCase
{
    ...
    public function testGetTreeWithOneLevel()
    {
        $collection = new CategoryCollection([
            ...
            new Category(2, null, [1], 'First level 02'),
            new Category(3, null, [1], 'First level 03'),
        ]);
    ...
    public function testGetNestedTree()
    {
        ...
        $this->assertEquals(
            [
                self::createCategory(1, null, [], 'First level 01', [
                    self::createCategory(2, 1, [1], 'Second level 01', [
                        self::createCategory(3, 2, [2, 1], 'Third level 01'),
                    ]),
                    self::createCategory(4, 1, [1], 'Second level 02', [
                        self::createCategory(5, 4, [4, 1], 'Third level 02'),
                    ]),
                ]),
            ],
            $collection->getTree(null)
    ...
    public function testGetTreeRemovesElementsWithoutParent()
    {
        $collection = new CategoryCollection([
            ...
            new Category(3, 2, [2, 1], 'Third level 01'),
            new Category(4, 1, [1], 'Second level 02'),
            new Category(5, 6, [6, 1], 'Third level 02'),
        ]);
    ...
    public function testSetWithKey()
    {
        ...
        $collection->set(0, new Category(3, 2, [2, 1], 'Third level 01'));
    ...
    public function testAddCategory()
    {
        ...
        $collection->add(new Category(2, 1, [1], 'Second level 01'));
    ...
    private static function createCategory(int $id, ?int $parentId, array $path, string $name, array $children = [])
    {

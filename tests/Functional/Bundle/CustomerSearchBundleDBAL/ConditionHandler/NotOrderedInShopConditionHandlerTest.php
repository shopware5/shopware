...
class NotOrderedInShopConditionHandlerTest extends TestCase
{
    public function testSingleShop(): void
    {
        $criteria = new Criteria();
        $criteria->addCondition(
            new NotOrderedInShopCondition([3])
        );
    ...
    public function testMultipleShops(): void
    {
        $criteria = new Criteria();
        $criteria->addCondition(
            new NotOrderedInShopCondition([1, 3])
        );

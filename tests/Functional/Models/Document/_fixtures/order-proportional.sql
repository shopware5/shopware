INSERT INTO `s_emarketing_vouchers` (`id`, `description`, `vouchercode`, `numberofunits`, `value`, `minimumcharge`, `shippingfree`, `bindtosupplier`, `valid_from`, `valid_to`, `ordercode`, `modus`, `percental`, `numorder`, `customergroup`, `restrictarticles`, `strict`, `subshopID`, `taxconfig`, `customer_stream_ids`)
VALUES
...
VALUES
    (60001,	'20003',	1,	19.91,	16.6,	4.95,	4.13,	21.75,	'2021-07-16 11:45:56',	0,	17,	5,	'',	'',	'',	'',	0,	0,	'',	'',	'',	NULL,	'',	'1',	17,	'EUR',	1,	1,	'172.18.0.0',	'desktop',	1,	'2021-07-16 11:45:56');
...
VALUES
    (2090001,	60001,	'20003',	178,	'SW10178',	19.95,	1,	'Strandtuch \"Ibiza\"',	0,	0,	0,	'0000-00-00',	0,	0,	5,	21.75,	'',	'',	'',	'Stück',	407),
    (2100001,	60001,	'20003',	50001,	'percentage',	-4.9875,	1,	'Gutschein 25 %',	0,	0,	0,	'0000-00-00',	2,	0,	0,	21.75,	'',	'',	'',	'',	0);
...
INSERT INTO `s_order_billingaddress_attributes` (`id`, `billingID`, `text1`, `text2`, `text3`, `text4`, `text5`, `text6`)
VALUES
    (300001,	300001,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL);

INSERT INTO `s_order_shippingaddress` (`id`, `userID`, `orderID`, `company`, `department`, `salutation`, `firstname`, `lastname`, `street`, `zipcode`, `city`, `phone`, `countryID`, `stateID`, `additional_address_line1`, `additional_address_line2`, `title`)
VALUES
    (300001,	1,	60001,	'shopware AG',	'',	'mr',	'Max',	'Mustermann',	'Mustermannstraße 92',	'48624',	'Schöppingen',	'',	2,	NULL,	'',	'',	'');

INSERT INTO `s_order_shippingaddress_attributes` (`id`, `shippingID`, `text1`, `text2`, `text3`, `text4`, `text5`, `text6`)
VALUES
    (300001,	300001,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL);

 ...
 */
class Shopware_Tests_Components_Api_CustomerGroupTest extends Enlight_Components_Test_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->resource = new \Shopware\Components\Api\Resource\CustomerGroup();

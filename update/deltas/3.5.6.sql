...
CREATE TABLE IF NOT EXISTS `new_s_addon_premiums` (
...
RENAME TABLE `new_s_addon_premiums` TO `s_addon_premiums`;
...
CREATE TABLE IF NOT EXISTS `new_s_articles_attributes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
RENAME TABLE `new_s_articles_categories` TO `s_articles_categories`;

CREATE TABLE IF NOT EXISTS `new_s_articles_details` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
RENAME TABLE `new_s_articles_img` TO `s_articles_img`;
...
RENAME TABLE `new_s_articles_prices` TO `s_articles_prices`;
...
RENAME TABLE `new_s_articles_supplier` TO `s_articles_supplier`;
...
RENAME TABLE `new_s_articles_translations` TO `s_articles_translations`;

CREATE TABLE IF NOT EXISTS `new_s_articles_vote` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `articleID` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
RENAME TABLE `new_s_articles_vote` TO `s_articles_vote`;

CREATE TABLE IF NOT EXISTS `new_s_billing_template` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
RENAME TABLE `new_s_billing_template` TO `s_billing_template`;
...
RENAME TABLE `new_s_cms_static` TO `s_cms_static`;
...
CREATE TABLE IF NOT EXISTS `new_s_cms_support` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `text` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
RENAME TABLE `new_s_cms_support` TO `s_cms_support`;
...
RENAME TABLE `new_s_cms_support_fields` TO `s_cms_support_fields`;
...
CREATE TABLE IF NOT EXISTS `new_s_core_auth` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `roleID` int(11) NOT NULL,
...
RENAME TABLE `new_s_core_auth` TO `s_core_auth`;
...
('226', '102', 'thumb', 'i:2;', 'Vorschaubild-Größe', NULL, 'number', '0', '0', '1', NULL, NULL, 'a:0:{}'),
...
('879', '256', 'premiumArticles', 'b:0;', 'Zeige Prämienartikel an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('880', '256', 'countryNotice', 'b:1;', 'Zeige Länder-Beschreibung an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('881', '256', 'nettoNotice', 'b:0;', 'Zeige Hinweis für Netto-Bestellungen an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
...
CREATE TABLE IF NOT EXISTS `new_s_core_config_mails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
RENAME TABLE `new_s_core_config_mails` TO `s_core_config_mails`;
...
RENAME TABLE `new_s_core_engine_elements` TO `s_core_engine_elements`;

CREATE TABLE IF NOT EXISTS `new_s_core_engine_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `layout` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT IGNORE INTO `new_s_core_log` (`id`, `type`, `key`, `text`, `value4`)
SELECT `id`, `type`, `key`, `text`, `value4` FROM `s_core_log`;
DROP TABLE IF EXISTS `s_core_log`;
RENAME TABLE `new_s_core_log` TO `s_core_log`;

CREATE TABLE IF NOT EXISTS `new_s_core_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent` int(11) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `new_s_core_multilanguage` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
RENAME TABLE `new_s_core_optin` TO `s_core_optin`;

CREATE TABLE IF NOT EXISTS `new_s_core_paymentmeans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `template` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `new_s_core_snippets` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `namespace` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
('2587', 'frontend/detail/comment', '1', '1', 'InquiryTextBasket', 'Bitte unterbreiten Sie mir ein Angebot über die nachfolgenden Positionen', '2012-09-27 14:00:33', '2012-09-27 14:00:33'),
...
('2647', 'frontend/account/order_item', '1', '2', 'OrderItemInfoCompleted', 'Completed', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),

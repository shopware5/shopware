...
TRUNCATE TABLE `s_core_sessions`, `s_core_log`;

RENAME TABLE `s_addon_premiums` TO `backup_s_addon_premiums`;
...
INSERT IGNORE INTO `s_addon_premiums` (`id`, `startprice`, `ordernumber`, `ordernumber_export`, `subshopID`)
SELECT `id`, `startprice`, `ordernumber`, `articleID`, `subshopID` FROM `backup_s_addon_premiums`;
DROP TABLE `backup_s_addon_premiums`;
...
INSERT IGNORE INTO `s_articles` (`id`, `supplierID`, `name`, `description`, `description_long`, `shippingtime`, `datum`, `active`, `taxID`, `pseudosales`, `topseller`, `keywords`, `changetime`, `pricegroupID`, `pricegroupActive`, `filtergroupID`, `laststock`, `crossbundlelook`, `notification`, `template`, `mode`)
SELECT `id`, `supplierID`, `name`, `description`, `description_long`, `shippingtime`, `datum`, `active`, `taxID`, `pseudosales`, `topseller`, `keywords`, `changetime`, `pricegroupID`, `pricegroupActive`, `filtergroupID`, `laststock`, `crossbundlelook`, `notification`, `template`, `mode` FROM `backup_s_articles`;

RENAME TABLE `s_articles_attributes` TO `backup_s_articles_attributes`;
...
INSERT IGNORE INTO `s_articles_attributes` (`id`, `articleID`, `articledetailsID`, `attr1`, `attr2`, `attr3`, `attr4`, `attr5`, `attr6`, `attr7`, `attr8`, `attr9`, `attr10`, `attr11`, `attr12`, `attr13`, `attr14`, `attr15`, `attr16`, `attr17`, `attr18`, `attr19`, `attr20`)
SELECT `id`, `articleID`, `articledetailsID`, `attr1`, `attr2`, `attr3`, `attr4`, `attr5`, `attr6`, `attr7`, `attr8`, `attr9`, `attr10`, `attr11`, `attr12`, `attr13`, `attr14`, `attr15`, `attr16`, `attr17`, `attr18`, `attr19`, `attr20` FROM `backup_s_articles_attributes`;
DROP TABLE `backup_s_articles_attributes`;

ALTER TABLE `s_articles_avoid_customergroups` ENGINE=InnoDB, CONVERT TO CHARACTER SET utf8, COLLATE utf8_unicode_ci;

RENAME TABLE `s_articles_categories` TO `backup_s_articles_categories`;
...
INSERT IGNORE INTO `s_articles_categories` (`id`, `articleID`, `categoryID`)
SELECT `id`, `articleID`, `categoryID` FROM `backup_s_articles_categories`;
DROP TABLE `backup_s_articles_categories`;

RENAME TABLE `s_articles_details` TO `backup_s_articles_details`;
...
INSERT IGNORE INTO `s_articles_details` (`id`, `articleID`, `ordernumber`, `suppliernumber`, `kind`, `additionaltext`, `impressions`, `sales`, `active`, `instock`, `stockmin`, `weight`, `position`)
SELECT `id`, `articleID`, `ordernumber`, `suppliernumber`, `kind`, `additionaltext`, `impressions`, `sales`, `active`, `instock`, `stockmin`, `weight`, `position` FROM `backup_s_articles_details`;
DROP TABLE `backup_s_articles_details`;
...
RENAME TABLE `s_articles_img` TO `backup_s_articles_img`;
...
INSERT IGNORE INTO `s_articles_img` (`id`, `articleID`, `img`, `main`, `description`, `position`, `width`, `height`, `relations`, `extension`)
SELECT `id`, `articleID`, `img`, `main`, `description`, `position`, `width`, `height`, `relations`, `extension` FROM `backup_s_articles_img`;
DROP TABLE `backup_s_articles_img`;
...
RENAME TABLE `s_articles_prices` TO `backup_s_articles_prices`;
...
INSERT IGNORE INTO `s_articles_prices` (`id`, `pricegroup`, `from`, `to`, `articleID`, `articledetailsID`, `price`, `pseudoprice`, `baseprice`, `percent`)
SELECT `id`, `pricegroup`, `from`, `to`, `articleID`, `articledetailsID`, `price`, `pseudoprice`, `baseprice`, `percent` FROM `backup_s_articles_prices`;
DROP TABLE `backup_s_articles_prices`;
...
RENAME TABLE `s_articles_supplier` TO `backup_s_articles_supplier`;
...
INSERT IGNORE INTO `s_articles_supplier` (`id`, `name`, `img`, `link`)
SELECT `id`, `name`, `img`, `link` FROM `backup_s_articles_supplier`;
DROP TABLE `backup_s_articles_supplier`;
...
RENAME TABLE `s_articles_translations` TO `backup_s_articles_translations`;
...
INSERT IGNORE INTO `s_articles_translations` (`id`, `articleID`, `languageID`, `name`, `keywords`, `description`, `description_long`, `description_clear`, `attr1`, `attr2`, `attr3`, `attr4`, `attr5`)
SELECT `id`, `articleID`, `languageID`, `name`, `keywords`, `description`, `description_long`, `description_clear`, `attr1`, `attr2`, `attr3`, `attr4`, `attr5` FROM `backup_s_articles_translations`;
DROP TABLE `backup_s_articles_translations`;

RENAME TABLE `s_articles_vote` TO `backup_s_articles_vote`;
...
INSERT IGNORE INTO `s_articles_vote` (`id`, `articleID`, `name`, `headline`, `comment`, `points`, `datum`, `active`, `email`)
SELECT `id`, `articleID`, `name`, `headline`, `comment`, `points`, `datum`, `active`, `email` FROM `backup_s_articles_vote`;
DROP TABLE `backup_s_articles_vote`;

RENAME TABLE `s_billing_template` TO `backup_s_billing_template`;
...
INSERT IGNORE INTO `s_billing_template` (`ID`, `name`, `value`, `typ`, `group`, `desc`, `position`, `show`)
SELECT `ID`, `name`, `value`, `typ`, `group`, `desc`, `position`, `show` FROM `backup_s_billing_template`;
DROP TABLE `backup_s_billing_template`;
...
RENAME TABLE `s_campaigns_containers` TO `backup_s_campaigns_containers`;
...
INSERT IGNORE INTO `s_campaigns_containers` (`id`, `promotionID`, `value`, `type`, `description`, `position`)
SELECT `id`, `promotionID`, `value`, `type`, `description`, `position` FROM `backup_s_campaigns_containers`;
DROP TABLE `backup_s_campaigns_containers`;

ALTER TABLE `s_campaigns_groups` ENGINE=InnoDB, CONVERT TO CHARACTER SET utf8, COLLATE utf8_unicode_ci;

RENAME TABLE `s_campaigns_html` TO `backup_s_campaigns_html`;
...
SELECT `id`, `parentID`, `headline`, `html`, `image`, `link`, `alignment` FROM `backup_s_campaigns_html`;
DROP TABLE `backup_s_campaigns_html`;
...
RENAME TABLE `s_campaigns_mailings` TO `backup_s_campaigns_mailings`;
...
INSERT IGNORE INTO `s_campaigns_mailings` (`id`, `datum`, `groups`, `subject`, `sendermail`, `sendername`, `plaintext`, `templateID`, `languageID`, `status`, `locked`, `recipients`, `read`, `clicked`, `customergroup`, `publish`)
SELECT `id`, `datum`, `groups`, `subject`, `sendermail`, `sendername`, `plaintext`, `templateID`, `languageID`, `status`, `locked`, `recipients`, `read`, `clicked`, `customergroup`, `publish` FROM `backup_s_campaigns_mailings`;
DROP TABLE `backup_s_campaigns_mailings`;
...
INSERT IGNORE INTO `s_categories` (`id`, `parent`, `description`, `position`, `metakeywords`, `metadescription`, `cmsheadline`, `cmstext`, `template`, `noviewselect`, `active`, `blog`, `showfiltergroups`, `external`, `hidefilter`, `hidetop`)
SELECT `id`, `parent`, `description`, `position`, `metakeywords`, `metadescription`, `cmsheadline`, `cmstext`, `template`, `noviewselect`, `active`, `blog`, `showfiltergroups`, `external`, `hidefilter`, `hidetop` FROM `backup_s_categories`;
DROP TABLE `backup_s_categories`;
...
RENAME TABLE `s_cms_content` TO `backup_s_cms_content`;
...
INSERT IGNORE INTO `s_cms_content` (`id`, `groupID`, `description`, `text`, `img`, `link`, `attachment`, `datum`)
SELECT `id`, `groupID`, `description`, `text`, `img`, `link`, `attachment`, `datum` FROM `backup_s_cms_content`;
DROP TABLE `backup_s_cms_content`;

ALTER TABLE `s_cms_groups` ENGINE=InnoDB, CONVERT TO CHARACTER SET utf8, COLLATE utf8_unicode_ci;

RENAME TABLE `s_cms_static` TO `backup_s_cms_static`;
...
INSERT IGNORE INTO `s_cms_static` (`id`, `tpl1variable`, `tpl1path`, `tpl2variable`, `tpl2path`, `tpl3variable`, `tpl3path`, `description`, `html`, `grouping`, `position`, `link`, `target`)
SELECT `id`, `tpl1variable`, `tpl1path`, `tpl2variable`, `tpl2path`, `tpl3variable`, `tpl3path`, `description`, `html`, `grouping`, `position`, `link`, `target` FROM `backup_s_cms_static`;
DROP TABLE `backup_s_cms_static`;
...
RENAME TABLE `s_cms_support` TO `backup_s_cms_support`;
...
INSERT IGNORE INTO `s_cms_support` (`id`, `name`, `text`, `email`, `email_template`, `email_subject`, `text2`, `ticket_typeID`, `isocode`)
SELECT `id`, `name`, `text`, `email`, `email_template`, `email_subject`, `text2`, `ticket_typeID`, `isocode` FROM `backup_s_cms_support`;
DROP TABLE `backup_s_cms_support`;
...
RENAME TABLE `s_cms_support_fields` TO `backup_s_cms_support_fields`;
...
INSERT IGNORE INTO `s_cms_support_fields` (`id`, `error_msg`, `name`, `note`, `typ`, `required`, `supportID`, `label`, `class`, `value`, `added`, `position`, `ticket_task`)
SELECT `id`, `error_msg`, `name`, `note`, `typ`, `required`, `supportID`, `label`, `class`, `value`, `added`, `position`, `ticket_task` FROM `backup_s_cms_support_fields`;
DROP TABLE `backup_s_cms_support_fields`;
...
RENAME TABLE `s_core_auth` TO `backup_s_core_auth`;
...
INSERT IGNORE INTO `s_core_auth` (`id`, `username`, `password`, `sessionID`, `lastlogin`, `name`, `email`, `active`, `admin`, `salted`, `failedlogins`, `lockeduntil`)
SELECT `id`, `username`, `password`, `sessionID`, `lastlogin`, `name`, `email`, `active`, `admin`, `salted`, `failedlogins`, `lockeduntil` FROM `backup_s_core_auth`;
DROP TABLE `backup_s_core_auth`;
...
('15', '191', '2', 'Prefix fÃ¼r automatically generated article number', NULL),
...
('189', '90', 'voteunlock', 'b:1;', 'Artikel-Bewertungen mÃ¼ssen freigeschaltet werden', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('190', '84', 'backendautoordernumber', 'b:1;', 'Automatischer Vorschlag der Artikelnummer', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('191', '84', 'backendautoordernumberprefix', 's:2:\"SW\";', 'PrÃ¤fix fÃ¼r automatisch generierte Artikelnummer', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('195', '86', 'taxautomode', 'b:1;', 'Steuer fÃ¼r Rabatte dynamisch feststellen', NULL, 'boolean', '0', '0', '1', NULL, NULL, NULL),
...
('226', '102', 'thumb', 's:1:\"0\";', 'Vorschaubild-GrÃ¶ÃŸe', NULL, 'text', '0', '0', '1', NULL, NULL, 'a:0:{}'),
...
('251', '127', 'cachecountries', 'i:86400;', 'LÃ¤nderliste Pufferzeit', NULL, 'interval', '0', '0', '0', NULL, NULL, NULL),
('252', '127', 'cachesearch', 'i:86400;', 'Cache Suche', NULL, 'interval', '0', '0', '0', NULL, NULL, NULL),
('253', '127', 'cachetranslations', 'i:86400;', 'Ãœbersetzungen Pufferzeit', NULL, 'interval', '0', '0', '0', NULL, NULL, NULL),
...
('256', '127', 'deletecacheafterorder', 'b:0;', 'Shopcache nach jeder Bestellung leeren (Performance lastig)', 'Warnung! Kann massive Performance-EinbrÃ¼che nach sich ziehen', 'boolean', '0', '0', '0', NULL, NULL, NULL),
('257', '127', 'disablecache', 'b:1;', 'Shopcache deaktivieren', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('269', '133', 'show', 'i:1;', 'MenÃ¼ zeigen', NULL, 'checkbox', '0', '0', '1', NULL, NULL, 'a:0:{}'),
...
('272', '133', 'cachetime', 'i:86400;', 'Cachezeit', NULL, 'interval', '0', '0', '0', NULL, NULL, 'a:0:{}'),
...
('280', '135', 'tagTime', 'i:30;', 'Die berÃ¼cksichtigte Zeit in Tagen', NULL, 'number', '0', '0', '1', NULL, NULL, 'a:0:{}'),
...
('290', '145', 'markastopseller', 's:2:\"30\";', 'Artikel als Topseller markieren (VerkÃ¤ufe)', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('291', '145', 'chartrange', 's:1:\"5\";', 'Anzahl Topseller fÃ¼r Charts', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('292', '144', 'numberarticlestoshow', 's:11:\"12|24|36|48\";', 'Auswahl Artikel pro Seite', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('293', '144', 'categorytemplates', 's:141:\"article_listing_1col.tpl:Liste;article_listing_2col.tpl:Zweispaltig;article_listing_3col.tpl:Dreispaltig;article_listing_4col.tpl:Vierspaltig\";', 'VerfÃ¼gbare Templates Kategorien', NULL, 'textarea', '0', '0', '0', NULL, NULL, NULL),
('294', '147', 'maxpurchase', 's:3:\"100\";', 'Max. wÃ¤hlbare Artikelmenge / Artikel Ã¼ber Pulldown-MenÃ¼', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('295', '147', 'notavailable', 's:21:\"Lieferzeit ca. 5 Tage\";', 'Text fÃ¼r nicht verfÃ¼gbare Artikel', NULL, 'text', '0', '0', '1', NULL, NULL, NULL),
('296', '146', 'maxcrosssimilar', 's:1:\"8\";', 'Anzahl Ã¤hnlicher Artikel Cross-Selling', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('297', '146', 'maxcrossalsobought', 's:1:\"8\";', 'Anzahl \"Kunden kauften auch\" Artikel Cross-Selling', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('298', '144', 'category_default_tpl', 's:24:\"article_listing_4col.tpl\";', 'Standard-Template fÃ¼r neue Kategorien', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('299', '145', 'chartinterval', 's:2:\"10\";', 'Anzahl der Tage, die fÃ¼r die Topseller-Generierung berÃ¼cksichtigt werden', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('300', '146', 'similarlimit', 's:1:\"3\";', 'Anzahl automatisch ermittelter, Ã¤hnlicher Artikel (Detailseite)', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('304', '147', 'inquiryvalue', 's:3:\"150\";', 'Mind. Warenkorbwert ab dem die MÃ¶glichkeit der individuellen Anfrage angeboten wird', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('314', '147', 'detailtemplates', 's:9:\":Standard\";', 'VerfÃ¼gbare Templates Detailseite', NULL, 'textarea', '0', '0', '0', NULL, NULL, NULL),
('315', '144', 'maxsupplierscategory', 's:2:\"30\";', 'Max. Anzahl Hersteller in Sidebar', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('317', '157', 'minpassword', 's:1:\"8\";', 'MindestlÃ¤nge Passwort (Registrierung)', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('319', '157', 'newsletterdefaultgroup', 's:1:\"1\";', 'Standard-Empfangsgruppe (ID) fÃ¼r registrierte Kunden (System / Newsletter)', NULL, 'text', '0', '0', '1', NULL, NULL, NULL),
...
('323', '157', 'actdprcheck', 'b:0;', 'Datenschutz-Bedingungen mÃ¼ssen Ã¼ber Checkbox akzeptiert werden', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
...
('585', '173', 'blockIp', 'N;', 'IP von Statistiken ausschlieÃŸen', NULL, 'text', '0', '0', '1', NULL, NULL, 'a:0:{}'),
...
('595', '177', 'AllowIP', 's:0:\"\";', 'Auf IP beschrÃ¤nken', NULL, 'text', '0', '0', '0', NULL, NULL, 'a:0:{}'),
...
('615', '190', 'minsearchlenght', 's:1:\"3\";', 'Minimale SuchwortlÃ¤nge', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('624', '192', 'no_order_mail', 'b:0;', 'BestellbestÃ¤tigung nicht an Shopbetreiber schicken', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('625', '190', 'badwords', 's:381:\"ab,die,der,und,in,zu,den,das,nicht,von,sie,ist,des,sich,mit,dem,dass,er,es,ein,ich,auf,so,eine,auch,als,an,nach,wie,im,fÃƒÂ¼r,einen,um,werden,mehr,zum,aus,ihrem,style,oder,neue,spieler,kÃƒÂ¶nnen,wird,sind,ihre,einem,of,du,sind,einer,ÃƒÂ¼ber,alle,neuen,bei,durch,kann,hat,nur,noch,zur,gegen,bis,aber,haben,vor,seine,ihren,jetzt,ihr,dir,etc,bzw,nach,deine,the,warum,machen,0,sowie,am\";', 'Blacklist fÃ¼r Keywords', NULL, 'text', '1', '0', '0', NULL, NULL, NULL),
('626', '191', 'paymentsurchargeadd', 's:25:\"Zuschlag fÃ¼r Zahlungsart\";', 'Bezeichnung proz. Zuschlag fÃ¼r Zahlungsart', NULL, 'text', '0', '0', '1', NULL, NULL, NULL),
('627', '191', 'paymentsurchargedev', 's:25:\"Abschlag fÃ¼r Zahlungsart\";', 'Bezeichnung proz. Abschlag fÃ¼r Zahlungsart', NULL, 'text', '0', '0', '1', NULL, NULL, NULL),
...
('630', '191', 'paymentsurchargenumber', 's:10:\"sw-payment\";', 'Zuschlag fÃ¼r Zahlungsart (Bestellnummer)', NULL, 'text', '0', '0', '1', NULL, NULL, NULL),
('631', '190', 'maxlivesearchresults', 's:1:\"6\";', 'Anzahl der Ergebnisse in der Livesuche', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('632', '191', 'ignoreshippingfreeforsurcharges', 'b:0;', 'Absolute ZahlungszuschlÃ¤ge fÃ¼r Versandkosten immer berechnen', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('633', '192', 'send_confirm_mail', 'b:1;', 'RegistrierungsbestÃ¤tigung in CC an Shopbetreiber schicken', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('634', '192', 'optinnewsletter', 'b:0;', 'Double-Opt-In fÃ¼r Newsletter-Anmeldungen', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
('635', '192', 'optinvote', 'b:1;', 'Double-Opt-In fÃ¼r Artikel-Bewertungen', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
...
('641', '192', 'orderstatemailack', 's:0:\"\";', 'Bestellstatus - Ã„nderungen CC-Adresse', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('643', '247', 'premiumshippingnoorder', 'b:0;', 'Bestellung bei keiner verfÃ¼gbaren Versandart blocken', NULL, 'boolean', '1', '0', '0', NULL, NULL, NULL),
...
('653', '249', 'seoremovewhitespaces', 'b:1;', 'Ã¼berflÃ¼ssige Leerzeichen / ZeilenumbrÃ¼chen entfernen', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
...
('662', '248', 'vatcheckadvancednumber', 's:0:\"\";', 'Eigene USt-IdNr. fÃ¼r die ÃœberprÃ¼fung', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
('663', '248', 'vatcheckadvanced', 'b:0;', 'Erweiterte ÃœberprÃ¼fung aktivieren', NULL, 'boolean', '0', '0', '1', NULL, NULL, NULL),
('664', '248', 'vatcheckadvancedcountries', 's:2:\"AT\";', 'gÃ¼ltige LÃ¤nder fÃ¼r erweiterte ÃœberprÃ¼fung', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('669', '248', 'vatchecknoservice', 'b:1;', 'Wenn Service nicht erreichbar ist, nur einfach ÃœberpÃ¼rfung durchfÃ¼hren.', NULL, 'boolean', '0', '0', '0', NULL, NULL, NULL),
...
('671', '248', 'vatcheckconfirmation', 'b:0;', 'Amtliche BestÃ¤tigungsmitteilung bei der erweiterten ÃœberprÃ¼fung anfordern', NULL, 'boolean', '0', '0', '1', NULL, NULL, NULL),
('672', '248', 'vatcheckvalidresponse', 's:4:\"A, D\";', 'GÃ¼ltige Ergebnisse bei der erweiterten ÃœberprÃ¼fung', NULL, 'text', '0', '0', '0', NULL, NULL, NULL),
...
('849', '147', 'blogdetailtemplates', 's:10:\":Standard;\";', 'VerfÃ¼gbare Templates Blog-Detailseite', NULL, 'textarea', '0', '0', '0', NULL, NULL, NULL),
('850', '190', 'fuzzysearchdistance', 'i:20;', 'Maximal-Distanz fÃ¼r Unscharfe Suche in Prozent', NULL, 'number', '1', '0', '1', NULL, NULL, NULL),
('851', '190', 'fuzzysearchexactmatchfactor', 'i:100;', 'Faktor fÃ¼r genaue Treffer', NULL, 'number', '1', '0', '1', NULL, NULL, NULL),
('852', '190', 'fuzzysearchlastupdate', 's:19:\"2010-01-01 00:00:00\";', 'Datum des letzten Updates', NULL, 'datetime', '0', '0', '0', NULL, NULL, NULL),
('853', '190', 'fuzzysearchmatchfactor', 'i:5;', 'Faktor fÃ¼r unscharfe Treffer', NULL, 'number', '1', '0', '1', NULL, NULL, NULL),
('854', '190', 'fuzzysearchmindistancentop', 'i:20;', 'Minimale Relevanz zum Topartikel in Prozent', NULL, 'number', '1', '0', '1', NULL, NULL, NULL),
('855', '190', 'fuzzysearchpartnamedistancen', 'i:25;', 'Maximal-Distanz fÃ¼r Teilnamen in Prozent', NULL, 'number', '1', '0', '1', NULL, NULL, NULL),
('856', '190', 'fuzzysearchpatternmatchfactor', 'i:50;', 'Faktor fÃ¼r Teiltreffer', NULL, 'number', '1', '0', '1', NULL, NULL, NULL),
...
('873', '256', 'revocationNotice', 'b:1;', 'Zeige Widerrufsbelehrung an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('874', '256', 'newsletter', 'b:0;', 'Zeige Newsletter-Registrierung an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('875', '256', 'bankConnection', 'b:0;', 'Zeige Bankverbindungshinweis an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('876', '256', 'additionalFreeText', 'b:0;', 'Zeige weiteren Hinweis an', 'Snippet: ConfirmTextOrderDefault', 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('877', '256', 'commentVoucherArticle', 'b:0;', 'Zeige weitere Optionen an', 'Artikel hinzuf&uuml;gen, Gutschein hinzuf&uuml;gen, Kommentarfunktion', 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('878', '256', 'bonusSystem', 'b:0;', 'Zeige Bonus-System an (falls installiert)', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('879', '256', 'premiumArticles', 'b:0;', 'Zeige PrÃ¤mienartikel an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('880', '256', 'countryNotice', 'b:1;', 'Zeige LÃ¤nder-Beschreibung an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('881', '256', 'nettoNotice', 'b:0;', 'Zeige Hinweis fÃ¼r Netto-Bestellungen an', NULL, 'boolean', '0', '0', '1', NULL, NULL, 'a:0:{}'),
('882', '256', 'basketHeaderColor', 's:7:\"#f5f5f5\";', 'Warenkorbkopf Hintergrundfarbe', '(Hex-Code)', 'color', '0', '1', '1', NULL, NULL, 'a:0:{}'),
('883', '256', 'basketHeaderFontColor', 's:4:\"#000\";', 'Warenkorbkopf Textfarbe', '(Hex-Code)', 'color', '0', '1', '1', NULL, NULL, 'a:0:{}'),
('884', '256', 'basketTableColor', 's:7:\"#f5f5f5\";', 'Warenkorbtabelle Hintergrundfarbe', '(Hex-Code)', 'color', '0', '1', '1', NULL, NULL, 'a:0:{}'),
('885', '256', 'mainFeatures', 's:290:\"{if $sBasketItem.additional_details.properties}\n    {$sBasketItem.additional_details.properties}\n{elseif $sBasketItem.additional_details.description}\n    {$sBasketItem.additional_details.description}\n{else}\n    {$sBasketItem.additional_details.description_long|strip_tags|truncate:50}\n{/if}\";', 'Template fÃ¼r die wesentliche Merkmale', NULL, 'textarea', '0', '1', '1', NULL, NULL, 'a:0:{}'),
('886', '259', 'backendTimeout', 'i:7200;', 'Timeout', NULL, 'interval', '1', '0', '0', NULL, NULL, 'a:0:{}'),
('887', '259', 'backendLocales', 'a:2:{i:0;i:1;i:1;i:2;}', 'AuswÃ¤hlbare Sprachen', NULL, 'select', '1', '0', '0', NULL, NULL, 'a:2:{s:5:\"store\";s:11:\"base.Locale\";s:11:\"multiSelect\";b:1;}'),
...
('891', '144', 'blogcategory', 's:0:\"\";', 'Blog-EintrÃ¤ge aus Kategorie (ID) auf Startseite anzeigen', '', 'text', '0', '0', '1', NULL, NULL, NULL),
('892', '144', 'bloglimit', 's:1:\"3\";', 'Anzahl Blog-EintrÃ¤ge auf Startseite', '', 'text', '0', '0', '1', NULL, NULL, NULL),
...
('897', '191', 'paymentSurchargeAbsolute', 's:25:\"Zuschlag fÃ¼r Zahlungsart\";', 'Pauschaler Aufschlag fÃ¼r Zahlungsart (Bezeichnung)', NULL, 'text', '1', '0', '1', NULL, NULL, NULL),
('898', '191', 'paymentSurchargeAbsoluteNumber', 's:19:\"sw-payment-absolute\";', 'Pauschaler Aufschlag fÃ¼r Zahlungsart (Bestellnummer)', NULL, 'text', '1', '0', '1', NULL, NULL, NULL),
('899', '262', 'StoreApiUrl', 's:33:\"http://store.shopware.de/storeApi\";', 'Store API Url', NULL, 'text', '0', '0', '1', NULL, NULL, 'a:0:{}');
...
('86', '79', 'Product35', 'Sonstige MwSt.-SÃ¤tze', NULL, '4', '1', NULL),
...
('120', '77', 'Currency', 'WÃ¤hrungen', NULL, '20', '0', NULL),
...
('133', '80', 'AdvancedMenu', 'Erweitertes MenÃ¼', '', '0', '1', '29'),
...
('146', '80', 'Frontend77', 'Cross-Selling / Ã„hnliche Art.', NULL, '3', '0', NULL),
...
INSERT IGNORE INTO `s_core_config_mails` (`id`, `name`, `frommail`, `fromname`, `subject`, `content`, `contentHTML`, `ishtml`, `attachment`)
SELECT `id`, `name`, `frommail`, `fromname`, `subject`, `content`, `contentHTML`, `ishtml`, `attachment` FROM `backup_s_core_config_mails`;
DROP TABLE `backup_s_core_config_mails`;
...
('7', 'DÃ¤nemark', 'DK', '3', 'DENMARK', '10', '', '0', '0', '0', '0', '0', 'DNK', '0', '0'),
...
('11', 'GroÃŸbritannien', 'GB', '3', 'GREAT BRITAIN', '10', '', '0', '0', '0', '0', '0', 'GBR', '0', '0'),
...
('23', 'Ã–sterreich', 'AT', '3', 'AUSTRIA', '1', '', '0', '0', '0', '0', '0', 'AUT', '0', '0'),
...
('32', 'TÃ¼rkei', 'TR', '2', 'TURKEY', '10', '', '0', '0', '0', '0', '0', 'TUR', '0', '0'),
...
RENAME TABLE `s_core_engine_elements` TO `backup_s_core_engine_elements`;
...
INSERT IGNORE INTO `s_core_engine_elements` (`id`, `domname`, `default`, `label`, `required`, `position`, `name`, `layout`, `variantable`, `help`, `translatable`)
SELECT `id`, `domname`, `domvalue`, `domdescription`, `required`, `position`, `databasefield`, `domclass`, `availablebyvariants`, `help`, `multilanguage` FROM `backup_s_core_engine_elements`;
DROP TABLE `backup_s_core_engine_elements`;

RENAME TABLE `s_core_engine_groups` TO `backup_s_core_engine_groups`;
...
INSERT IGNORE INTO `s_core_engine_groups` (`id`, `position`)
SELECT `id`, `position` FROM `backup_s_core_engine_groups`;
DROP TABLE `backup_s_core_engine_groups`;
...
RENAME TABLE `s_core_log` TO `backup_s_core_log`;
...
INSERT IGNORE INTO `s_core_log` (`id`, `type`, `key`, `text`, `date`, `value4`)
SELECT `id`, `type`, `key`, `text`, `datum`, `value4` FROM `backup_s_core_log`;
DROP TABLE `backup_s_core_log`;
...
('31', '69', '', 'Ãœbersicht', NULL, NULL, 'sprite-report-paper', '-5', '1', NULL, '13', 'Overview', NULL, 'Index'),
...
('44', '40', '', 'Ãœber Shopware', 'createShopwareVersionMessage()', NULL, 'sprite-shopware-logo', '2', '1', NULL, NULL, 'AboutShopware', NULL, 'Index'),
...
('66', '1', '', 'Ãœbersicht', '', NULL, 'sprite-ui-scroll-pane-list', '-2', '1', NULL, '13', 'ArticleList', 'STRG + ALT + O', 'Index'),
...
INSERT IGNORE INTO `s_core_multilanguage` (`id`, `isocode`, `locale`, `parentID`, `flagstorefront`, `flagbackend`, `skipbackend`, `name`, `defaultcustomergroup`, `template`, `doc_template`, `separate_numbers`, `domainaliase`, `defaultcurrency`, `default`, `switchCurrencies`, `switchLanguages`, `fallback`, `navigation`)
SELECT `id`, `isocode`, `locale`, `parentID`, `flagstorefront`, `flagbackend`, `skipbackend`, `name`, `defaultcustomergroup`, `template`, `doc_template`, `separate_numbers`, `domainaliase`, `defaultcurrency`, `default`, `switchCurrencies`, `switchLanguages`, `fallback`, `navigation` FROM `backup_s_core_multilanguage`;
DROP TABLE `backup_s_core_multilanguage`;

RENAME TABLE `s_core_optin` TO `backup_s_core_optin`;
...
INSERT IGNORE INTO `s_core_optin` (`id`, `datum`, `hash`, `data`)
SELECT `id`, `datum`, `hash`, `data` FROM `backup_s_core_optin`;
DROP TABLE `backup_s_core_optin`;
...
INSERT IGNORE INTO `s_core_paymentmeans` (`id`, `name`, `description`, `template`, `class`, `table`, `hide`, `additionaldescription`, `debit_percent`, `surcharge`, `surchargestring`, `position`, `active`, `esdactive`, `embediframe`, `hideprospect`, `action`, `pluginID`)
SELECT `id`, `name`, `description`, `template`, `class`, `table`, `hide`, `additionaldescription`, `debit_percent`, `surcharge`, `surchargestring`, `position`, `active`, `esdactive`, `embediframe`, `hideprospect`, `action`, `pluginID` FROM `backup_s_core_paymentmeans`;
DROP TABLE `backup_s_core_paymentmeans`;
...
('1', 'Core', 'Log', 'Log', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('2', 'Core', 'ErrorHandler', 'ErrorHandler', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('3', 'Core', 'Debug', 'Debug', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('4', 'Core', 'BenchmarkEvents', 'BenchmarkEvents', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('5', 'Core', 'Benchmark', 'Benchmark', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('7', 'Core', 'Cron', 'Cron', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('8', 'Core', 'Router', 'Router', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('9', 'Core', 'CronBirthday', 'CronBirthday', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('10', 'Core', 'System', 'System', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('11', 'Core', 'ViewportForward', 'ViewportForward', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('12', 'Core', 'Shop', 'Shop', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('13', 'Core', 'PostFilter', 'PostFilter', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('14', 'Core', 'CronRating', 'CronRating', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('15', 'Core', 'ControllerBase', 'ControllerBase', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('16', 'Core', 'CronStock', 'CronStock', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('17', 'Core', 'Api', 'Api', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('18', 'Core', 'License', 'License', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('19', 'Frontend', 'RouterRewrite', 'RouterRewrite', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('20', 'Frontend', 'Compare', 'Compare', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('21', 'Frontend', 'Facebook', 'Facebook', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('22', 'Frontend', 'Seo', 'Seo', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('23', 'Frontend', 'LastArticles', 'LastArticles', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('24', 'Frontend', 'RouterOld', 'RouterOld', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('26', 'Frontend', 'Google', 'Google', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('29', 'Frontend', 'AdvancedMenu', 'AdvancedMenu', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('31', 'Frontend', 'Statistics', 'Statistics', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('33', 'Frontend', 'Notification', 'Notification', 'Default', '', '', '0', '2012-08-28 00:00:00', NULL, NULL, NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('34', 'Frontend', 'TagCloud', 'TagCloud', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('35', 'Frontend', 'InputFilter', 'InputFilter', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('36', 'Backend', 'Auth', 'Auth', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('37', 'Backend', 'Menu', 'Menu', 'Default', '', '', '1', '2012-08-28 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2010, shopware AG', '', '1', 'http://www.shopware.de/wiki/', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
...
('40', 'Backend', 'Check', 'Systeminfo', 'Default', '', '', '1', '2010-10-18 00:00:00', '2010-10-18 00:00:00', '2010-10-18 00:00:00', NULL, 'shopware AG', 'Copyright Â© 2011, shopware AG', '', '1.0.0', 'http://wiki.shopware.de', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
...
('44', 'Core', 'RestApi', 'RestApi', 'Default', '', '', '1', '2012-07-13 12:03:13', '2012-07-13 12:03:36', '2012-07-13 12:03:36', NULL, 'shopware AG', 'Copyright Â© 2012, shopware AG', '', '1.0.0', 'http://wiki.shopware.de', '', 'http://www.shopware.de/', NULL, NULL, '0', '0', '0', NULL, NULL),
('45', 'Backend', 'StoreApi', 'StoreApi', 'Default', NULL, NULL, '1', '2012-08-19 14:34:36', '2012-08-19 14:34:46', '2012-08-19 14:34:46', '2012-08-21 09:59:19', 'shopware AG', 'Copyright Â© 2012, shopware AG', NULL, '1.0.0', NULL, NULL, NULL, NULL, NULL, '1', '0', '0', NULL, NULL),
('46', 'Core', 'PluginManager', 'PluginManager', 'Default', NULL, NULL, '1', '2012-08-19 14:34:36', '2012-08-19 14:34:46', '2012-08-19 14:34:59', '2012-08-21 09:59:19', 'shopware AG', 'Copyright Â© 2012, shopware AG', NULL, '1.0.0', NULL, NULL, NULL, NULL, NULL, '1', '0', '0', NULL, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2587 DEFAULT COLLATE=utf8_unicode_ci;
...
('8', 'frontend/compare/index', '1', '1', 'CompareActionDelete', 'Vergleich lÃ¶schen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('15', 'frontend/checkout/confirm', '1', '1', 'ConfirmErrorAGB', 'Bitte bestÃ¤tigen Sie unsere AGB', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('34', 'frontend/listing/listing_actions', '1', '1', 'ListingSortPriceHighest', 'HÃ¶chster Preis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('46', 'frontend/detail/navigation', '1', '1', 'DetailNavIndex', 'Ãœbersicht', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('60', 'frontend/detail/comment', '1', '1', 'DetailCommentHeader', 'Kundenbewertungen fÃ¼r', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('62', 'frontend/detail/comment', '1', '1', 'DetailCommentTextReview', 'Bewertungen werden nach ÃœberprÃ¼fung freigeschaltet.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('80', 'frontend/detail/similar', '1', '1', 'DetailSimilarHeader', 'Ã„hnliche Artikel', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('83', 'frontend/search/paging', '1', '1', 'ListingSortPriceHighest', 'HÃ¶chster Preis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('87', 'frontend/checkout/ajax_add_article', '1', '1', 'AjaxAddHeaderCrossSelling', 'Diese Artikel kÃ¶nnten Ihnen gefallen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('94', 'frontend/account/ajax_login', '1', '1', 'LoginActionClose', 'Fenster schlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('98', 'frontend/listing/listing_actions', '1', '1', 'ListingLinkNext', 'NÃ¤chste Seite', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('102', 'frontend/register/personal_fieldset', '1', '1', 'RegisterPersonalHeadline', 'Ihre persÃ¶nlichen Angaben', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('118', 'frontend/register/personal_fieldset', '1', '1', 'RegisterInfoPassword2', 'BerÃ¼cksichtigen Sie GroÃŸ- und Kleinschreibung.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('121', 'frontend/plugins/index/delivery_informations', '1', '1', 'DetailDataInfoNotAvailable', 'Diese Auswahl steht nicht zur VerfÃ¼gung!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('126', 'frontend/register/billing_fieldset', '1', '1', 'RegisterBillingLabelStreet', 'StraÃŸe und Nr*:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('129', 'frontend/register/billing_fieldset', '1', '1', 'RegisterBillingLabelSelect', 'Bitte wÃ¤hlen...', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('137', 'frontend/register/shipping_fieldset', '1', '1', 'RegisterShippingLabelStreet', 'StraÃŸe und Nr*:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('140', 'frontend/register/shipping_fieldset', '1', '1', 'RegisterShippingLabelSelect', 'Bitte wÃ¤hlen...', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('141', 'frontend/register/payment_fieldset', '1', '1', 'RegisterPaymentHeadline', 'Bitte wÃ¤hlen Sie die von Ihnen bevorzugte Zahlungsart', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('149', 'frontend/detail/navigation', '1', '1', 'DetailNavPrevious', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('150', 'frontend/detail/comment', '1', '1', 'DetailCommentInfoFillOutFields', 'Bitte fÃ¼llen Sie alle rot markierten Felder aus', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('155', 'frontend/forms/index', '1', '1', 'FormsTextContact', '<strong>Demoshop<br />\r\n</strong><br />\r\nFÃ¼gen Sie hier Ihre Kontaktdaten ein', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('160', 'frontend/account/shipping', '1', '1', 'ShippingLinkSend', 'Ã„ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('166', 'frontend/checkout/confirm_left', '1', '1', 'ConfirmLinkChangeBilling', 'Ã„ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('169', 'frontend/checkout/confirm_left', '1', '1', 'ConfirmLinkChangeShipping', 'Ã„ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('170', 'frontend/checkout/confirm_left', '1', '1', 'ConfirmLinkSelectShipping', 'Andere', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('171', 'frontend/checkout/confirm_left', '1', '1', 'ConfirmHeaderPayment', 'GewÃ¤hlte Zahlungsart', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('172', 'frontend/checkout/confirm_left', '1', '1', 'ConfirmInfoInstantDownload', 'Kauf von Direktdownloads nur per Lastschrift oder Kreditkarte mÃ¶glich', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('173', 'frontend/checkout/confirm_left', '1', '1', 'ConfirmLinkChangePayment', 'Ã„ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('174', 'frontend/account/billing', '1', '1', 'BillingLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('179', 'frontend/account/content_right', '1', '1', 'AccountLinkBillingAddress', 'Rechnungsadresse Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('180', 'frontend/account/content_right', '1', '1', 'AccountLinkShippingAddress', 'Lieferadresse Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('181', 'frontend/account/content_right', '1', '1', 'AccountLinkPayment', 'Zahlungsart Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('185', 'frontend/account/index', '1', '1', 'AccountHeaderInfo', 'Dies ist Ihr Konto Dashboard, wo Sie die MÃ¶glichkeit haben, Ihre letzten KontoaktivitÃ¤ten einzusehen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('188', 'frontend/account/index', '1', '1', 'AccountLinkChangePassword', 'Passwort Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('189', 'frontend/account/index', '1', '1', 'AccountLinkChangePayment', 'Zahlungsart Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('193', 'frontend/account/index', '1', '1', 'AccountLabelWantNewsletter', 'Ja, ich mÃ¶chte den kostenlosen {$sShopname} Newsletter erhalten. Sie kÃ¶nnen sich jederzeit wieder abmelden!', '2010-01-01 00:00:00', '2010-10-15 13:25:20'),
...
('195', 'frontend/account/index', '1', '1', 'AccountHeaderPrimaryBilling', 'PrimÃ¤re Rechnungsadresse', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('196', 'frontend/account/index', '1', '1', 'AccountLinkSelectBilling', 'Andere wÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('197', 'frontend/account/index', '1', '1', 'AccountHeaderPrimaryShipping', 'PrimÃ¤re Lieferadresse', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('198', 'frontend/account/index', '1', '1', 'AccountLinkSelectShipping', 'Andere wÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('209', 'frontend/account/order_item', '1', '1', 'OrderItemColumnPrice', 'StÃ¼ckpreis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('220', 'frontend/note/index', '1', '1', 'NoteText2', 'Einfach den gewÃ¼nschten Artikel auf die Merkliste setzen und {$sShopname} speichert fÃ¼r Sie automatisch Ihre persÃ¶nliche Merkliste.\r\nSo kÃ¶nnen Sie bequem bei einem spÃ¤teren Besuch Ihre vorgemerkten Artikel wieder abrufen.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('221', 'frontend/note/index', '1', '1', 'NoteColumnName', 'Artikel', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('222', 'frontend/note/index', '1', '1', 'NoteColumnPrice', 'StÃ¼ckpreis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('223', 'frontend/checkout/error_messages', '1', '1', 'ConfirmInfoPaymentNotCompatibleWithESD', 'Diese Zahlungsart steht fÃ¼r Sofortdownloads nicht zur VerfÃ¼gung', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('230', 'frontend/checkout/ajax_cart', '1', '1', 'AjaxCartLinkBasket', 'Warenkorb Ã¶ffnen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('236', 'frontend/newsletter/index', '1', '1', 'sNewsletterInfo', 'Abonnieren Sie jetzt einfach unseren regelmÃ¤ÃŸig erscheinenden\r\nNewsletter und Sie werden stets als Erster Ã¼ber\r\nneue Artikel und Angebote informiert.<br />\r\nDer Newsletter ist natÃ¼rlich jederzeit Ã¼ber einen Link in der\r\neMail oder dieser Seite wieder abbestellbar.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('260', 'frontend/tellafriend/index', '1', '1', 'TellAFriendLabelFriendsMail', 'EmpfÃ¤nger eMail-Adresse', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('263', 'frontend/tellafriend/index', '1', '1', 'TellAFriendLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('274', 'frontend/compare/overlay', '1', '1', 'CompareActionClose', 'SchlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('275', 'frontend/detail/comment', '1', '1', 'DetailCommentInfoSuccess', 'Vielen Dank fÃ¼r die Abgabe Ihrer Bewertung! Ihre Bewertung wird nach ÃœberprÃ¼fung freigeschaltet.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('287', 'frontend/note/item', '1', '1', 'NoteLinkDelete', 'LÃ¶schen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('288', 'frontend/note/item', '1', '1', 'NoteLinkBuy', 'Kaufen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('289', 'frontend/detail/buy', '1', '1', 'DetailBuyValueSelect', 'Bitte wÃ¤hlen...', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('293', 'frontend/compare/added', '1', '1', 'LoginActionClose', 'SchlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('296', 'frontend/newsletter/detail', '1', '1', 'NewsletterDetailLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('297', 'frontend/newsletter/detail', '1', '1', 'NewsletterDetailLinkNewWindow', 'Newsletter in neuem Fenster Ã¶ffnen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('330', 'frontend/checkout/cart_header', '1', '1', 'CartColumnAvailability', 'VerfÃ¼gbarkeit', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('331', 'frontend/checkout/cart_header', '1', '1', 'CartColumnPrice', 'StÃ¼ckpreis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('333', 'frontend/checkout/cart_item', '1', '1', 'CartItemLinkDelete', 'LÃ¶schen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('334', 'frontend/checkout/cart_footer_left', '1', '1', 'CheckoutFooterActionAddVoucher', 'HinzufÃ¼gen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('335', 'frontend/checkout/cart_footer_left', '1', '1', 'CheckoutFooterLabelAddArticle', 'Artikel hinzufÃ¼gen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('337', 'frontend/checkout/cart_footer_left', '1', '1', 'CheckoutFooterActionAdd', 'HinzufÃ¼gen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('342', 'frontend/checkout/confirm', '1', '1', 'ConfirmHeader', 'Bitte Ã¼berprÃ¼fen Sie Ihre Bestellung nochmals, bevor Sie sie senden.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('348', 'frontend/checkout/confirm', '1', '1', 'ConfirmTextOrderDefault', 'Optionaler FreitextBei Zahlung per Bankeinzug oder per Kreditkarte erfolgt die Belastung Ihres Kontos fÃ¼nf Tage nach Bestellung der Ware.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('350', 'frontend/account/password', '1', '1', 'PasswordHeader', 'Passwort vergessen? Hier kÃ¶nnen Sie ein neues Passwort anfordern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('351', 'frontend/account/password', '1', '1', 'PasswordLabelMail', 'Ihre eMail-Adresse:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('352', 'frontend/account/password', '1', '1', 'PasswordText', 'Wir senden Ihnen ein neues, zufÃ¤llig generiertes Passwort. Dieses kÃ¶nnen Sie dann im Kundenbereich Ã¤ndern.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('353', 'frontend/account/password', '1', '1', 'PasswordLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('356', 'frontend/detail/bundle/box_bundle', '1', '1', 'BundleInfoPriceForAll', 'Preis fÃ¼r alle', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('359', 'frontend/detail/description', '1', '1', 'DetailDescriptionHeaderDownloads', 'VerfÃ¼gbare Downloads:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('360', 'frontend/detail/description', '1', '1', 'DetailDescriptionLinkDownload', 'Download', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('361', 'frontend/checkout/premiums', '1', '1', 'PremiumsHeader', 'Bitte wÃ¤hlen Sie zwischen den folgenden PrÃ¤mien', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('362', 'frontend/newsletter/index', '1', '1', 'NewsletterTitle', 'Newsletter', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('363', 'frontend/checkout/premiums', '1', '1', 'PremiumActionAdd', 'PrÃ¤mie auswÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('378', 'frontend/account/index', '1', '1', 'AccountLinkChangeBilling', 'Rechnungsadresse Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('379', 'frontend/account/index', '1', '1', 'AccountLinkChangeShipping', 'Lieferadresse Ã¤ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('386', 'frontend/account/downloads', '1', '1', 'DownloadsInfoAccessDenied', 'Dieser Download stehen Ihnen nicht zur VerfÃ¼gung!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('387', 'frontend/account/downloads', '1', '1', 'DownloadsInfoNotFound', 'Keine Downloads verfÃ¼gbar', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('389', 'frontend/account/index', '1', '1', 'AccountHeaderPayment', 'GewÃ¤hlte Zahlungsart', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('390', 'frontend/account/index', '1', '1', 'AccountInfoInstantDownloads', 'Kauf von Direktdownloads nur per Lastschrift oder Kreditkarte mÃ¶glich', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('391', 'frontend/account/index', '1', '1', 'AccountSalutationMr', 'Herr', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('392', 'frontend/account/shipping', '1', '1', 'ShippingLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('393', 'frontend/account/select_shipping', '1', '1', 'SelectShippingHeader', 'AuswÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('394', 'frontend/account/select_address', '1', '1', 'SelectAddressSubmit', 'AuswÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('395', 'frontend/account/select_address', '1', '1', 'SelectAddressSalutationMs', 'Frau', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('396', 'frontend/account/select_shipping', '1', '1', 'SelectShippingLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('397', 'frontend/account/payment', '1', '1', 'PaymentLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('401', 'frontend/plugins/trusted_shops/logo', '1', '1', 'WidgetsTrustedLogo', 'Trusted Shops GÃ¼tesiegel - Bitte hier GÃ¼ltigkeit prÃ¼fen!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('403', 'frontend/checkout/finish', '1', '1', 'FinishHeaderThankYou', 'Vielen Dank fÃ¼r Ihre Bestellung bei ', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('404', 'frontend/checkout/finish', '1', '1', 'FinishInfoConfirmationMail', 'Wir haben Ihnen eine BestellbestÃ¤tigung per eMail geschickt.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('405', 'frontend/checkout/finish', '1', '1', 'FinishInfoPrintOrder', 'Wir empfehlen die unten aufgefÃ¼hrte BestellbestÃ¤tigung auszudrucken.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('406', 'frontend/checkout/finish', '1', '1', 'FinishLinkPrint', 'BestellbestÃ¤tigung jetzt ausdrucken!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('420', 'frontend/account/orders', '1', '1', 'OrdersInfoEmpty', 'Sie haben noch keine Bestellung durchgefÃ¼hrt.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('426', 'frontend/checkout/cart_item', '1', '1', 'CartItemInfoPremium', 'Als kleines DankeschÃ¶n, bekommen Sie diesen Artikel Gratis dazu', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('427', 'frontend/checkout/cart_item', '1', '1', 'CartItemInfoBundle', 'BUNDLE RABATT', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('428', 'frontend/account/select_billing', '1', '1', 'SelectBillingLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('429', 'frontend/account/select_billing', '1', '1', 'SelectBillingHeader', 'AuswÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('431', 'frontend/account/select_shipping', '1', '1', 'SelectShippingInfoEmpty', 'Nachdem Sie die erste Bestellung durchgefÃ¼hrt haben, kÃ¶nnen Sie hier auf vorherige Lieferadressen zugreifen.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('432', 'frontend/blog/atom', '1', '1', 'BlogAtomFeedHeader', 'Blog / Atom Feed', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('433', 'frontend/blog/comments', '1', '1', 'BlogInfoFailureFields', 'Bitte fÃ¼llen Sie alle rot markierten Felder aus', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('434', 'frontend/blog/comments', '1', '1', 'BlogInfoSuccessOptin', 'Vielen Dank fÃ¼r die Abgabe Ihrer Bewertung! \r\n	Sie erhalten in wenigen Minuten eine BestÃ¤tigungsmail.\r\n	BestÃ¤tigen Sie den Link in dieser eMail um die Bewertung freizugeben.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('435', 'frontend/blog/comments', '1', '1', 'BlogInfoSuccess', 'Vielen Dank fÃ¼r die Abgabe Ihrer Bewertung! Ihre Bewertung wird nach ÃœberprÃ¼fung freigeschaltet.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('436', 'frontend/blog/detail', '1', '1', 'BlogHeaderDownloads', 'VerfÃ¼gbare Downloads:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('448', 'frontend/checkout/cart', '1', '1', 'CartInfoNoDispatch', 'Achtung: FÃ¼r Ihr Warenkorb/Adresse wurde keine Versandart hinterlegt.<br /> Bitte kontaktieren Sie den Shopbetreiber.<br />', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('449', 'frontend/checkout/confirm', '1', '1', 'ConfirmHeaderNewsletter', 'MÃ¶chten Sie mehr Informationen?', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('450', 'frontend/checkout/confirm', '1', '1', 'ConfirmLabelNewsletter', 'Ja, ich mÃ¶chte den kostenlosen {$sShopname} Newsletter erhalten! Sie kÃ¶nnen sich jederzeit wieder abmelden!', '2010-01-01 00:00:00', '2010-10-15 13:24:52'),
...
('461', 'frontend/content/detail', '1', '1', 'ContentLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('462', 'frontend/content/index', '1', '1', 'ContentLinkDetails', '[mehr]', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('463', 'frontend/content/index', '1', '1', 'ContentInfoEmpty', 'Derzeit keine EintrÃ¤ge vorhanden', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('464', 'frontend/detail/article_config_step', '1', '1', 'DetailConfigValueSelect', 'Bitte wÃ¤hlen...', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('468', 'frontend/detail/bundle/box_related', '1', '1', 'BundleInfoPriceForAll', 'Preis fÃ¼r alle', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('469', 'frontend/compare/added', '1', '1', 'CompareActionClose', 'SchlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('470', 'frontend/detail/buy', '1', '1', 'DetailBuyInfoNotAvailable', 'Dieser Artikel steht derzeit nicht zur VerfÃ¼gung!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('471', 'frontend/detail/buy', '1', '1', 'DetailBuyLabelSurcharge', 'Aufpreis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('472', 'frontend/detail/comment', '1', '1', 'DetailCommentInfoSuccessOptin', 'Vielen Dank fÃ¼r die Abgabe Ihrer Bewertung! \r\n	Sie erhalten in wenigen Minuten eine BestÃ¤tigungsmail.\r\n	BestÃ¤tigen Sie den Link in dieser eMail um die Bewertung freizugeben.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('473', 'frontend/detail/comment', '1', '1', 'DetailCommentLabelMail', 'Ihre eMail-Adresse', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('474', 'frontend/compare/added', '1', '1', 'CompareInfoMaxReached', 'Es kÃ¶nnen maximal {config name=maxComparisons} Artikel in einem Schritt verglichen werden', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('475', 'frontend/newsletter/index', '1', '1', 'NewsletterLabelSelect', 'Bitte wÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('479', 'frontend/detail/data', '1', '1', 'DetailDataColumnPrice', 'StÃ¼ckpreis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('487', 'frontend/detail/liveshopping/category_countdown', '1', '1', 'LiveCountdownRemainingPieces', 'StÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('488', 'frontend/detail/liveshopping/category_countdown', '1', '1', 'LiveCountdownPriceFails', 'Preis fÃ¤llt um', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('494', 'frontend/detail/liveshopping/detail_countdown', '1', '1', 'LiveCountdownRemainingPieces', 'StÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('495', 'frontend/detail/liveshopping/detail_countdown', '1', '1', 'LiveCountdownPriceFails', 'Preis fÃ¤llt um', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('498', 'frontend/account/payment', '1', '1', 'PaymentLinkSend', 'Ã„ndern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('503', 'frontend/detail/liveshopping/ticker/timeline', '1', '1', 'LiveTimeRemainingPieces', 'StÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('505', 'frontend/plugins/notification/index', '1', '1', 'DetailNotifyInfoErrorMail', 'Bitte geben Sie eine gÃ¼ltige eMail-Adresse ein', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('509', 'frontend/plugins/notification/index', '1', '1', 'DetailNotifyInfoSuccess', 'BestÃ¤tigen Sie den Link der eMail die Sie gerade erhalten haben. Sie erhalten dann eine eMail sobald der Artikel wieder verfÃ¼gbar ist', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('510', 'frontend/forms/index', '1', '1', 'FormsLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('511', 'frontend/forms/elements', '1', '1', 'SupportInfoFillRedFields', 'Bitte fÃ¼llen Sie alle rot markierten Felder aus.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('513', 'frontend/tellafriend/index', '1', '1', 'TellAFriendInfoFields', 'Bitte fÃ¼llen Sie alle benÃ¶tigten Felder aus', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('514', 'frontend/index/footer', '1', '1', 'FooterInfoExcludeVat', '* Alle Preise verstehen sich zzgl. Mehrwertsteuer und <span style=\"text-decoration: underline;\"><a title=\"Versandkosten\" href=\"{url controller=custom sCustom=6}\">Versandkosten</a></span> und ggf. NachnahmegebÃ¼hren, wenn nicht anders beschrieben', '2010-01-01 00:00:00', '2010-10-14 14:45:36'),
...
('522', 'frontend/compare/overlay', '1', '1', 'LoginActionClose', 'SchlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('523', 'frontend/compare/overlay', '1', '1', 'CompareHeader', 'Produktvergleich', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('524', 'frontend/newsletter/listing', '1', '1', 'NewsletterListingInfoEmpty', 'Derzeit keine EintrÃ¤ge vorhanden', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('527', 'frontend/register/index', '1', '1', 'RegisterHeadlineSupplier', 'HÃ¤ndler-Anmeldung', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('528', 'frontend/register/index', '1', '1', 'RegisterInfoSupplier', 'Sie besitzen bereits einen HÃ¤ndleraccount?', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('532', 'frontend/register/index', '1', '1', 'RegisterInfoSupplier5', 'Senden Sie Ihren Gewerbenachweis per Fax an +49 2555 92 95 61. Wenn Sie bereits HÃ¤ndler bei uns sind,<br />kÃ¶nnen Sie diesen Schritt Ã¼berspringen und mÃ¼ssen natÃ¼rlich keinen Gewerbenachweis senden.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('533', 'frontend/register/index', '1', '1', 'RegisterInfoSupplier6', 'Wir prÃ¼fen Ihre Angaben und schalten Sie frei!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('534', 'frontend/register/index', '1', '1', 'RegisterInfoSupplier7', 'Wir schalten Sie nach PrÃ¼fung als HÃ¤ndler frei. Sie erhalten dann von uns eine Info per E-Mail.<br />Von nun an sehen Sie direkt Ihren HÃ¤ndler-EK, auf den Produkt und Ãœbersichtsseiten.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('550', 'frontend/ticket/navigation', '1', '1', 'TicketLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('551', 'frontend/ticket/navigation', '1', '1', 'TicketLinkSupport', 'Support beantragen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('552', 'frontend/ticket/navigation', '1', '1', 'TicketLinkIndex', 'SupportÃ¼bersicht', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('560', 'frontend/checkout/ajax_add_article', '1', '1', 'LoginActionClose', 'SchlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('567', 'frontend/plugins/trusted_shops/form', '1', '1', 'WidgetsTrustedShopsHeadline', 'Trusted Shops GÃ¼tesiegel - Bitte hier klicken.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('571', 'frontend/plugins/trusted_shops/form', '1', '1', 'WidgetsTrustedShopsInfo', 'Anmeldung zur Geld-zurÃ¼ck-Garantie', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('574', 'frontend/checkout/premiums', '1', '1', 'PremiumInfoSelect', 'Bitte wÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('576', 'frontend/account/ajax_logout', '1', '1', 'LoginActionClose', 'SchlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('586', 'frontend/detail/description', '1', '1', 'ArticleTipMoreInformation', 'WeiterfÃ¼hrende Links zu', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('592', 'frontend/plugins/index/delivery_informations', '1', '1', 'DetailDataInfoInstantDownload', 'Als Sofortdownload verfÃ¼gbar', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('597', 'frontend/checkout/confirm_item', '1', '1', 'CheckoutItemPrice', 'StÃ¼ckpreis', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('598', 'frontend/custom/ajax', '1', '1', 'CustomAjaxActionNewWindow', 'Im neuen Fenster Ã¶ffnen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('599', 'frontend/account/ajax_logout', '1', '1', 'AccountLogoutButton', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('606', 'frontend/note/item', '1', '1', 'NoteLinkZoom', 'Bild vergrÃ¶ÃŸern', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('607', 'frontend/newsletter/index', '1', '1', 'NewsletterRegisterBillingLabelCity', 'Plz / Ort', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('608', 'frontend/newsletter/index', '1', '1', 'NewsletterRegisterBillingLabelStreet', 'StraÃŸe / Hausnr.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('613', 'frontend/newsletter/index', '1', '1', 'NewsletterRegisterPleaseChoose', 'Bitte wÃ¤hlen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('614', 'frontend/newsletter/index', '1', '1', 'NewsletterRegisterLabelSalutation', 'Anrede', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('615', 'frontend/register/index', '1', '1', 'RegisterIndexActionSubmit', 'Registrierung abschlieÃŸen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('616', 'frontend/checkout/added', '1', '1', 'CheckoutAddArticleLinkBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('619', 'frontend/checkout/confirm_footer', '1', '1', 'CheckoutFinishTaxInformation', 'Der EmpfÃ¤nger der Leistung schuldet die Steuer', '2010-01-01 00:00:00', '2010-10-16 10:37:58'),
('620', 'frontend/checkout/confirm_item', '1', '1', 'CartItemInfoFree', 'Kostenlos', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('621', 'frontend/account/password', '1', '1', 'LoginBack', 'ZurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('624', 'frontend/detail/error', '1', '1', 'DetailRelatedHeader', 'Dieser Artikel ist leider nicht mehr verfÃ¼gbar!', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('625', 'frontend/detail/error', '1', '1', 'DetailRelatedHeaderSimilarArticles', 'Ã„hnliche Artikel:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('626', 'frontend/plugins/notification/index', '1', '1', 'DetailNotifyInfoValid', 'Vielen Dank!\r\n\r\nWir haben Ihre Anfrage gespeichert!\r\nSie werden benachrichtigt sobald der Artikel wieder verfÃ¼gbar ist.\r\n', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('628', 'frontend/search/paging', '1', '1', 'ListingPaging', 'BlÃ¤ttern:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('629', 'frontend/search/paging', '1', '1', 'ListingLinkPrevious', 'Seite zurÃ¼ck', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('633', 'frontend/listing/listing_actions', '1', '1', 'ListingPaging', 'BlÃ¤ttern:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('639', 'frontend/detail/header', '1', '1', 'DetailChooseFirst', 'Bitte wÃ¤hlen Sie zuerst eine Variante aus', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('640', 'frontend/custom/ajax', '1', '1', 'CustomAjaxActionClose', 'Schliessen', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
('641', 'frontend', '1', '1', 'sMailConfirmation', 'Vielen Dank. Wir haben Ihnen eine BestÃ¤tigungsemail gesendet. Klicken Sie auf den enthaltenen Link um Ihre Anmeldung zu bestÃ¤tigen.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('644', 'frontend/checkout/cart_footer_left', '1', '1', 'CheckoutFooterLabelAddVoucher', 'Gutschein hinzufÃ¼gen:', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('650', 'frontend/account/billing', '1', '1', 'BillingLinkSend', 'Ã„ndern', '2010-09-23 21:23:52', '2010-09-28 11:54:19'),
...
('703', 'frontend/content/paging', '1', '1', 'ListingPaging', 'BlÃ¤ttern:', '2010-09-26 11:44:05', '2010-09-28 11:54:19'),
('704', 'frontend/content/paging', '1', '1', 'ListingLinkPrevious', 'ZurÃ¼ck', '2010-09-26 11:44:05', '2010-09-28 11:54:19'),
...
('710', 'frontend/ticket/detail', '1', '1', 'TicketDetailLinkBack', 'ZurÃ¼ck', '2010-09-26 15:14:11', '2010-09-28 11:54:19'),
...
('714', 'frontend/detail/config_step', '1', '1', 'DetailConfigValueSelect', 'Bitte wÃ¤hlen', '2010-09-27 11:19:49', '2010-09-28 11:54:19'),
('715', 'frontend/detail/config_step', '1', '1', 'DetailConfigActionSubmit', 'AuswÃ¤hlen', '2010-09-27 11:19:49', '2010-09-28 11:54:19'),
('716', 'frontend/detail/config_upprice', '1', '1', 'DetailConfigActionSubmit', 'AuswÃ¤hlen', '2010-09-27 11:19:49', '2010-09-28 11:54:19'),
...
('722', 'frontend/plugins/recommendation/blocks_index', '1', '1', 'IndexSimilaryArticlesSlider', 'Ã„hnliche Artikel wie die, die Sie sich angesehen haben:', '2010-09-27 15:36:42', '2010-09-28 11:54:19'),
...
('1367', 'frontend', '1', '1', 'CheckoutArticleLessStock', 'Leider kÃ¶nnen wir den von Ihnen gewÃ¼nschten Artikel nicht mehr in ausreichender StÃ¼ckzahl liefern. (#0 von #1 lieferbar).', '2010-09-27 17:36:07', '2010-09-28 11:54:19'),
...
('1390', 'documents/index', '1', '1', 'DocumentIndexAdviceNet', 'Hinweis: Der EmpfÃ¤nger der Leistung schuldet die Steuer.', '2010-09-28 13:02:44', '2010-09-28 13:02:44'),
('1391', 'documents/index', '1', '1', 'DocumentIndexSelectedPayment', 'Gew&auml;hlte Zahlungsart', '2010-09-28 13:02:44', '2010-09-28 13:02:44'),
('1392', 'documents/index', '1', '1', 'DocumentIndexVoucher', '\n						FÃ¼r den nÃ¤chsten Einkauf schenken wir Ihnen einen {$Document.voucher.value} {$Document.voucher.prefix} Gutschein\n						mit dem Code \"{$Document.voucher.code}\".<br />\n					', '2010-09-28 13:02:44', '2010-09-28 13:02:44'),
('1393', 'documents/index', '1', '1', 'DocumentIndexComment', 'Kommentar:', '2010-09-28 13:02:44', '2010-09-28 13:02:44'),
('1394', 'documents/index', '1', '1', 'DocumentIndexSelectedDispatch', 'GewÃ¤hlte Versandart:', '2010-09-28 13:02:44', '2010-09-28 13:02:44'),
('1395', 'documents/index', '1', '1', 'DocumentIndexCurrency', '\n					<br>Euro Umrechnungsfaktor: {$Order._currency.factor|replace:\".\":\",\"}\n					', '2010-09-28 13:02:44', '2010-09-28 13:02:44'),
('1399', 'frontend', '1', '1', 'AccountPasswordNotEqual', 'Die PasswÃ¶rter stimmen nicht Ã¼berein.', '2010-09-29 20:32:08', '2010-09-29 20:32:08'),
...
('1403', 'frontend', '1', '1', 'CheckoutSelectVariant', 'Bitte wÃ¤hlen Sie eine Variante aus, um den gewÃ¼nschte Artikel in den Warenkorb zu legen.', '2010-10-01 10:53:18', '2010-10-01 10:53:18'),
('1404', 'frontend/account/index', '1', '1', 'AccountLinkChangeMail', 'E-Mail Ã¤ndern', '2010-01-01 00:00:00', '2010-01-01 00:00:00'),
...
('1407', 'frontend/plugins/notification/index', '1', '1', 'DetailNotifyAlreadyRegistered', 'Sie haben sich bereits fÃ¼r eine Benachrichtigung eingetragen!', '2010-01-01 00:00:00', '2010-10-06 12:28:47'),
...
('1430', 'frontend', '1', '1', 'CheckoutArticleNoStock', 'Leider kÃ¶nnen wir den von Ihnen gewÃ¼nschten Artikel nicht mehr in ausreichender StÃ¼ckzahl liefern.', '2010-10-05 23:11:09', '2010-10-05 23:11:09'),
...
('1433', 'frontend/checkout/confirm', '1', '1', 'ConfirmErrorStock', 'Ein Artikel aus Ihrer Bestellung ist nicht mehr verfÃ¼gbar! Bitte entfernen Sie die Position aus dem Warenkorb!', '2010-10-06 19:41:24', '2010-10-06 19:41:24'),
...
('1447', 'frontend/checkout/confirm', '1', '1', 'ConfirmLabelDispatch', 'Aktuell ausgewÃ¤hlte Versandart', '2010-10-07 21:09:32', '2010-10-07 21:09:32'),
('1448', 'frontend/checkout/confirm', '1', '1', 'ConfirmLinkChangeDispatch', 'Ã„ndern', '2010-10-07 21:09:32', '2010-10-07 21:09:32'),
...
('1482', 'backend/plugins/coupons/pdf/index', '1', '1', 'PluginsBackendCouponsInfo', 'Der Gutschein ist gÃ¼ltig bis zum \r\n				', '2010-10-11 15:38:57', '2010-10-11 15:38:57'),
...
('1484', 'backend/plugins/coupons/pdf/index', '1', '1', 'PluginsBackendCouponsText', '\n				Sie kÃ¶nnen den Gutschein einfach wÃ¤hrend des Bestellprozesses im Warenkorb einlÃ¶sen.\n				Wir wÃ¼nschen Ihnen viel SpaÃŸ bei dem Besuch unseres Shops. Bei Fragen oder Problemen erreichen Sie uns jederzeit\n				unter folgenden Kontaktdaten: Musterfirma | MusterstraÃŸe | Musterort\n				', '2010-10-11 15:44:56', '2010-10-11 15:44:56'),
...
('1498', 'newsletter/index/footer', '1', '1', 'NewsletterFooterLinkNewWindow', 'Newsletter im Browser Ã¶ffnen', '2010-10-12 10:05:03', '2010-10-12 10:05:03'),
...
('1500', 'frontend/detail/liveshopping/category', '1', '1', 'LiveCategoryPreviousPrice', 'UrsprÃ¼nglicher Preis:', '2010-10-12 19:39:32', '2010-10-12 19:39:32'),
...
('1509', 'frontend', '1', '1', 'CheckoutSelectPremiumVariant', 'Bitte wÃ¤hlen Sie eine Variante aus, um den gewÃ¼nschte PrÃ¤mie in den Warenkorb zu legen.', '2010-10-13 17:38:03', '2010-10-13 17:38:03'),
...
('1514', 'frontend/plugins/recommendation/blocks_listing', '1', '1', 'IndexSimilaryArticlesSlider', 'Ã„hnliche Artikel wie die, die Sie sich angesehen haben:', '2010-10-15 00:35:20', '2010-10-15 00:35:20'),
...
('1540', 'frontend/compare/add_article', '1', '1', 'CompareInfoMaxReached', 'Es kÃ¶nnen maximal {config name=maxComparisons} Artikel in einem Schritt verglichen werden', '2010-10-17 09:10:41', '2010-10-17 09:10:41'),
...
('1545', 'frontend/account/select_billing', '1', '1', 'SelectBillingTitle', 'Adresse auswÃ¤hlen', '2010-10-18 00:29:20', '2010-10-18 00:57:55'),
('1546', 'frontend/account/billing', '1', '1', 'ChangeBillingTitle', 'Rechnungsadresse Ã¤ndern', '2010-10-18 00:29:20', '2010-10-18 00:56:36'),
('1547', 'frontend/account/shipping', '1', '1', 'ChangeShippingTitle', 'Lieferadresse Ã¤ndern', '2010-10-18 00:29:59', '2010-10-18 00:57:08'),
('1548', 'frontend/checkout/finish_footer', '1', '1', 'CheckoutFinishTaxInformation', 'Der EmpfÃ¤nger der Leistung schuldet die Steuer', '2010-10-18 00:31:38', '2010-10-18 00:31:38'),
('1549', 'frontend/account/payment', '1', '1', 'ChangePaymentTitle', 'Zahlungsart Ã¤ndern', '2010-10-18 00:57:15', '2010-10-18 00:57:25'),
('1550', 'frontend/account/select_shipping', '1', '1', 'SelectShippingTitle', 'Adresse auswÃ¤hlen', '2010-10-18 00:58:04', '2010-10-18 00:58:11'),
('1551', 'frontend/error/exception', '1', '1', 'InformText', 'Wir wurden bereits Ã¼ber das Problem informiert und arbeiten an einer LÃ¶sung, bitte versuchen Sie es in KÃ¼rze erneut.', '2010-10-25 16:51:50', '2010-10-25 16:51:50'),
...
('1587', 'frontend/account/internalMessages', '1', '1', 'LoginFailureLocked', 'Zu viele fehlgeschlagene Versuche. Ihr Account wurde vorÃ¼bergehend deaktivert - bitte probieren Sie es in einigen Minuten erneut!', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1588', 'frontend/account/internalMessages', '1', '1', 'LoginFailureActive', 'Ihr Kundenkonto wurde deaktiviert, bitte wenden Sie sich zwecks KlÃ¤rung persÃ¶nlich an uns!', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1590', 'frontend/account/internalMessages', '1', '1', 'ErrorFillIn', 'Bitte fÃ¼llen Sie alle rot markierten Felder aus', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1592', 'frontend/account/internalMessages', '1', '1', 'NewsletterMailDeleted', 'Ihre eMail-Adresse wurde gelÃ¶scht', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1596', 'frontend/account/internalMessages', '1', '1', 'NewsletterFailureInvalid', 'Bitte geben Sie eine gÃ¼ltige eMail-Adresse ein', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1598', 'frontend/account/internalMessages', '1', '1', 'VatFailureDate', 'Die eingegebene USt-IdNr. ist ungÃ¼ltig. Sie ist erst ab dem %s gÃ¼ltig.', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1599', 'frontend/account/internalMessages', '1', '1', 'VatFailureUnknownError', 'Es ist ein unerwarteter Fehler bei der ÃœberprÃ¼fung der USt-IdNr. aufgetreten. Bitte kontaktieren Sie den Shopbetreiber. Fehlercode: %d', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1601', 'frontend/account/internalMessages', '1', '1', 'VatFailureErrorFields', 'Firma,Ort,PLZ,StraÃŸe,Land', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1602', 'frontend/account/internalMessages', '1', '1', 'VatFailureInvalid', 'Die eingegebene USt-IdNr. ist ungÃ¼ltig.', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1604', 'frontend/account/internalMessages', '1', '1', 'MailFailureNotEqual', 'Die eMail-Adressen stimmen nicht Ã¼berein.', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1605', 'frontend/account/internalMessages', '1', '1', 'MailFailure', 'Bitte geben Sie eine gÃ¼ltige eMail-Adresse ein', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1607', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureMinimumCharge', 'Der Mindestumsatz fÃ¼r diesen Gutschein betrÃ¤gt {sMinimumCharge} â‚¬', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1608', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureSupplier', 'Dieser Gutschein ist nur fÃ¼r Produkte von {sSupplier} gÃ¼ltig', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1609', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureProducts', 'Dieser Gutschein ist nur fÃ¼r bestimmte Produkte gÃ¼ltig.', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1610', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureCustomerGroup', 'Dieser Gutschein ist fÃ¼r Ihre Kundengruppe nicht verfÃ¼gbar', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1611', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureOnlyOnes', 'Pro Bestellung kann nur ein Gutschein eingelÃ¶st werden', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1612', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureNotFound', 'Gutschein konnte nicht gefunden werden oder ist nicht mehr gÃ¼ltig', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1613', 'frontend/basket/internalMessages', '1', '1', 'VoucherFailureAlreadyUsed', 'Dieser Gutschein wurde bereits bei einer vorherigen Bestellung eingelÃ¶st', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1614', 'frontend/ticket/internalMessages', '1', '1', 'TicketFailureFields', 'Bitte fÃ¼llen Sie alle Felder aus!', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1615', 'frontend/ticket/internalMessages', '1', '1', 'TicketReplySuccessful', 'Ihre Antwort wurde erfolgreich Ã¼bertragen!', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('1619', 'frontend/account/partner_statistic', '1', '1', 'PartnerStatisticHeader', 'Provisions Ãœbersicht', '2012-06-22 12:59:53', '2012-06-25 16:54:02'),
...
('1640', 'frontend/blog/comments', '1', '1', 'DetailCommentTextReview', 'Kommentare werden nach ÃœberprÃ¼fung freigeschaltet.', '2010-01-01 00:00:00', '2010-09-28 11:54:19'),
...
('2489', 'frontend/index/footer', '1', '1', 'IndexCopyright', 'Copyright Â©  - Alle Rechte vorbehalten', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2490', 'newsletter/index/footer', '1', '1', 'NewsletterFooterCopyright', 'Copyright Â©  - Alle Rechte vorbehalten', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2491', 'frontend/register/steps', '1', '1', 'CheckoutStepBasketText', 'Ihr Warenkorb', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2493', 'frontend/register/steps', '1', '1', 'CheckoutStepConfirmText', 'PrÃ¼fen und Bestellen', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
...
('2528', 'frontend/register/billing_fieldset', '1', '2', 'RegisterBillingLabelSelect', 'Please selectâ€¦', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2529', 'frontend/register/shipping_fieldset', '1', '2', 'RegisterShippingLabelSelect', 'Please selectâ€¦', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
...
('2535', 'frontend/tellafriend/index', '1', '2', 'TellAFriendLabelFriendsMail', 'RecipientÂ´s email address ', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2536', 'frontend/detail/buy', '1', '2', 'DetailBuyValueSelect', 'Please selectâ€¦', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
...
('2539', 'frontend/detail/article_config_step', '1', '2', 'DetailConfigValueSelect', 'Please selectâ€¦', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
...
('2547', 'newsletter/index/footer', '1', '2', 'NewsletterFooterCopyright', 'Copyright Â© 2010 shopware AG - All rights reserved.', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
...
('2566', 'frontend/detail/tabs', '1', '1', 'DetailTabsAccessories', 'ZubehÃ¶r', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2567', 'frontend/detail/tabs', '1', '2', 'DetailTabsAccessories', 'Accessories', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
('2568', 'frontend/checkout/shipping_costs', '1', '1', 'StateSelection', 'Bitte wÃ¤hlen:', '2012-08-22 15:57:47', '2012-08-22 15:57:47'),
...
RENAME TABLE `s_core_tax` TO `backup_s_core_tax`;
...
INSERT IGNORE INTO `s_core_tax` (`id`, `tax`, `description`)
SELECT `id`, `tax`, `description` FROM `backup_s_core_tax`;
DROP TABLE `backup_s_core_tax`;
...
('6', 'swag-merchant-widget', 'HÃ¤ndlerfreischaltung');

RENAME TABLE `s_crontab` TO `backup_s_crontab`;
...
INSERT IGNORE INTO `s_crontab` (`id`, `name`, `action`, `elementID`, `data`, `next`, `start`, `interval`, `active`, `end`, `inform_template`, `inform_mail`, `pluginID`)
SELECT `id`, `name`, `action`, `elementID`, `data`, `next`, `start`, `interval`, `active`, `end`, `inform_template`, `inform_mail`, `pluginID` FROM `backup_s_crontab`;
DROP TABLE `backup_s_crontab`;

RENAME TABLE `s_emarketing_banners` TO `backup_s_emarketing_banners`;
...
INSERT IGNORE INTO `s_emarketing_banners` (`id`, `description`, `valid_from`, `valid_to`, `img`, `link`, `link_target`, `categoryID`, `extension`, `liveshoppingID`)
SELECT `id`, `description`, `valid_from`, `valid_to`, `img`, `link`, `link_target`, `categoryID`, `extension`, `liveshoppingID` FROM `backup_s_emarketing_banners`;
DROP TABLE `backup_s_emarketing_banners`;
...
RENAME TABLE `s_emarketing_partner` TO `backup_s_emarketing_partner`;
...
INSERT IGNORE INTO `s_emarketing_partner` (`id`, `idcode`, `datum`, `company`, `contact`, `street`, `streetnumber`, `zipcode`, `city`, `phone`, `fax`, `country`, `email`, `web`, `profil`, `fix`, `percent`, `cookielifetime`, `active`)
SELECT `id`, `idcode`, `datum`, `company`, `contact`, `street`, `streetnumber`, `zipcode`, `city`, `phone`, `fax`, `country`, `email`, `web`, `profil`, `fix`, `percent`, `cookielifetime`, `active` FROM `backup_s_emarketing_partner`;
DROP TABLE `backup_s_emarketing_partner`;
...
RENAME TABLE `s_emarketing_promotion_html` TO `backup_s_emarketing_promotion_html`;
...
INSERT IGNORE INTO `s_emarketing_promotion_html` (`id`, `parentID`, `headline`, `html`)
SELECT `id`, `parentID`, `headline`, `html` FROM `backup_s_emarketing_promotion_html`;
DROP TABLE `backup_s_emarketing_promotion_html`;
...
RENAME TABLE `s_emarketing_referer` TO `backup_s_emarketing_referer`;
...
INSERT IGNORE INTO `s_emarketing_referer` (`id`, `userID`, `referer`, `date`)
SELECT `id`, `userID`, `referer`, `date` FROM `backup_s_emarketing_referer`;
DROP TABLE `backup_s_emarketing_referer`;

ALTER TABLE `s_emarketing_tellafriend` ENGINE=InnoDB, CONVERT TO CHARACTER SET utf8, COLLATE utf8_unicode_ci;

RENAME TABLE `s_emarketing_voucher_codes` TO `backup_s_emarketing_voucher_codes`;
...
INSERT IGNORE INTO `s_emarketing_voucher_codes` (`id`, `voucherID`, `userID`, `code`, `cashed`)
SELECT `id`, `voucherID`, `userID`, `code`, `cashed` FROM `backup_s_emarketing_voucher_codes`;
DROP TABLE `backup_s_emarketing_voucher_codes`;

RENAME TABLE `s_emarketing_vouchers` TO `backup_s_emarketing_vouchers`;
...
INSERT IGNORE INTO `s_emarketing_vouchers` (`id`, `description`, `vouchercode`, `numberofunits`, `value`, `minimumcharge`, `shippingfree`, `bindtosupplier`, `valid_from`, `valid_to`, `ordercode`, `modus`, `percental`, `numorder`, `customergroup`, `restrictarticles`, `strict`, `subshopID`, `taxconfig`)
SELECT `id`, `description`, `vouchercode`, `numberofunits`, `value`, `minimumcharge`, `shippingfree`, `bindtosupplier`, `valid_from`, `valid_to`, `ordercode`, `modus`, `percental`, `numorder`, `customergroup`, `restrictarticles`, `strict`, `subshopID`, `taxconfig` FROM `backup_s_emarketing_vouchers`;
DROP TABLE `backup_s_emarketing_vouchers`;
...
RENAME TABLE `s_export` TO `backup_s_export`;
...
INSERT IGNORE INTO `s_export` (`id`, `name`, `last_export`, `active`, `hash`, `show`, `count_articles`, `expiry`, `interval`, `formatID`, `last_change`, `filename`, `encodingID`, `categoryID`, `currencyID`, `customergroupID`, `partnerID`, `languageID`, `active_filter`, `image_filter`, `stockmin_filter`, `instock_filter`, `price_filter`, `own_filter`, `header`, `body`, `footer`, `count_filter`, `multishopID`, `variant_export`)
SELECT `id`, `name`, `last_export`, `active`, `hash`, `show`, `count_articles`, `expiry`, `interval`, `formatID`, `last_change`, `filename`, `encodingID`, `categoryID`, `currencyID`, `customergroupID`, `partnerID`, `languageID`, `active_filter`, `image_filter`, `stockmin_filter`, `instock_filter`, `price_filter`, `own_filter`, `header`, `body`, `footer`, `count_filter`, `multishopID`, `variant_export` FROM `backup_s_export`;
DROP TABLE `backup_s_export`;
...
INSERT IGNORE INTO `s_filter_values` (`id`, `optionID`, `value`)
SELECT `id`, `optionID`, `value` FROM `backup_s_filter_values`;
DROP TABLE `backup_s_filter_values`;
...
('13', '7', 'banner_slider_title', 'textfield', '', 'Ãœberschrift', '', '', '', '', '', '', '', '0'),
...
('28', '10', 'manufacturer_slider_title', 'textfield', '', 'Ãœberschrift', '', '', '', '', '', '', '', '0'),
...
('39', '11', 'article_slider_title', 'textfield', '', 'Ãœberschrift', '', '', '', '', '', '', '', '0'),
...
SELECT `id`, `ordernumber`, `userID`, `invoice_amount`, `invoice_amount_net`, `invoice_shipping`, `invoice_shipping_net`, `ordertime`, `status`, `cleared`, `paymentID`, `transactionID`, `comment`, `customercomment`, `internalcomment`, `net`, `taxfree`, `partnerID`, `temporaryID`, `referer`, `cleareddate`, `trackingcode`, `language`, `dispatchID`, `currency`, `currencyFactor`, `subshopID`, `remote_addr` FROM `backup_s_order`;
...
INSERT IGNORE INTO `s_order_basket` (`id`, `sessionID`, `userID`, `articlename`, `articleID`, `ordernumber`, `shippingfree`, `quantity`, `price`, `netprice`, `datum`, `modus`, `esdarticle`, `partnerID`, `lastviewport`, `useragent`, `config`, `currencyFactor`, `liveshoppingID`, `bundleID`, `bundle_join_ordernumber`)
SELECT `id`, `sessionID`, `userID`, `articlename`, `articleID`, `ordernumber`, `shippingfree`, `quantity`, `price`, `netprice`, `datum`, `modus`, `esdarticle`, `partnerID`, `lastviewport`, `useragent`, `config`, `currencyFactor`, `liveshoppingID`, `bundleID`, `bundle_join_ordernumber` FROM `backup_s_order_basket`;
...
INSERT IGNORE INTO `s_order_billingaddress` (`id`, `userID`, `orderID`, `company`, `department`, `salutation`, `customernumber`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `phone`, `fax`, `countryID`, `ustid`)
SELECT `id`, `userID`, `orderID`, `company`, `department`, `salutation`, `customernumber`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `phone`, `fax`, `countryID`, `ustid` FROM `backup_s_order_billingaddress`;
...
INSERT IGNORE INTO `s_order_details` (`id`, `orderID`, `ordernumber`, `articleID`, `articleordernumber`, `price`, `quantity`, `name`, `status`, `shipped`, `shippedgroup`, `releasedate`, `modus`, `esdarticle`, `taxID`, `config`)
SELECT `id`, `orderID`, `ordernumber`, `articleID`, `articleordernumber`, `price`, `quantity`, `name`, `status`, `shipped`, `shippedgroup`, `releasedate`, `modus`, `esdarticle`, `taxID`, `config` FROM `backup_s_order_details`;
...
INSERT IGNORE INTO `s_order_shippingaddress` (`id`, `userID`, `orderID`, `company`, `department`, `salutation`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `countryID`)
SELECT `id`, `userID`, `orderID`, `company`, `department`, `salutation`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `countryID` FROM `backup_s_order_shippingaddress`;
...
RENAME TABLE `s_premium_dispatch` TO `backup_s_premium_dispatch`;
...
RENAME TABLE `s_search_fields` TO `backup_s_search_fields`;
...
INSERT IGNORE INTO `s_search_fields` (`id`, `name`, `relevance`, `field`, `tableID`)
SELECT `id`, `name`, `relevance`, `field`, `tableID` FROM `backup_s_search_fields`;
DROP TABLE `backup_s_search_fields`;
...
RENAME TABLE `s_statistics_referer` TO `backup_s_statistics_referer`;
...
INSERT IGNORE INTO `s_statistics_referer` (`id`, `datum`, `referer`)
SELECT `id`, `datum`, `referer` FROM `backup_s_statistics_referer`;
DROP TABLE `backup_s_statistics_referer`;

ALTER TABLE `s_statistics_search` ENGINE=InnoDB, CONVERT TO CHARACTER SET utf8, COLLATE utf8_unicode_ci;

RENAME TABLE `s_statistics_visitors` TO `backup_s_statistics_visitors`;
...
INSERT IGNORE INTO `s_statistics_visitors` (`id`, `datum`, `pageimpressions`, `uniquevisits`)
SELECT `id`, `datum`, `pageimpressions`, `uniquevisits` FROM `backup_s_statistics_visitors`;
DROP TABLE `backup_s_statistics_visitors`;

RENAME TABLE `s_user` TO `backup_s_user`;
CREATE TABLE `s_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT IGNORE INTO `s_user` (`id`, `password`, `email`, `active`, `accountmode`, `confirmationkey`, `paymentID`, `firstlogin`, `lastlogin`, `sessionID`, `newsletter`, `validation`, `affiliate`, `customergroup`, `paymentpreset`, `language`, `subshopID`, `referer`, `pricegroupID`, `internalcomment`, `failedlogins`, `lockeduntil`)
SELECT `id`, `password`, `email`, `active`, `accountmode`, `confirmationkey`, `paymentID`, `firstlogin`, `lastlogin`, `sessionID`, `newsletter`, `validation`, `affiliate`, `customergroup`, `paymentpreset`, `language`, `subshopID`, `referer`, `pricegroupID`, `internalcomment`, `failedlogins`, `lockeduntil` FROM `backup_s_user`;
DROP TABLE `backup_s_user`;
...
INSERT IGNORE INTO `s_user_billingaddress` (`id`, `userID`, `company`, `department`, `salutation`, `customernumber`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `phone`, `fax`, `countryID`, `ustid`, `birthday`)
SELECT `id`, `userID`, `company`, `department`, `salutation`, `customernumber`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `phone`, `fax`, `countryID`, `ustid`, `birthday` FROM `backup_s_user_billingaddress`;
...
INSERT IGNORE INTO `s_user_shippingaddress` (`id`, `userID`, `company`, `department`, `salutation`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `countryID`)
SELECT `id`, `userID`, `company`, `department`, `salutation`, `firstname`, `lastname`, `street`, `streetnumber`, `zipcode`, `city`, `countryID` FROM `backup_s_user_shippingaddress`;

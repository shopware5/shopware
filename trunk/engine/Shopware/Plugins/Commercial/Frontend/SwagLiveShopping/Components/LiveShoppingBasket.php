...
/**
 * The Shopware_Components_LiveShoppingBasket class is the basis for the new Shopware shopping basket.
 ...
 * @Shopware\noEncryption
 */
class Shopware_Components_LiveShoppingBasket extends Enlight_Class implements Enlight_Hook
{
    /**

 ...
 * @author shopware AG
 */
//{block name="backend/live_shopping/view/live_shopping/tabs/customer_group"}
//{namespace name="backend/live_shopping/article/view/main"}
Ext.define('Shopware.apps.Article.view.live_shopping.tabs.CustomerGroup', {
     ...
     */
    alias: 'widget.live-shopping-customer-group-listing',

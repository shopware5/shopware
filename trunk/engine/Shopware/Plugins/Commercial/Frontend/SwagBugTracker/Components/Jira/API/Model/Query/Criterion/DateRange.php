...
/**
 * Query criterion that can be used to filter issues that were created in a
 * date range.
 */
class DateRange extends Criterion
{
    /**
     * @var \DateTime
     */
    ...
    /**
     * Instantiates a new criterion for the given dates.
     *
     * @param \DateTime $from
     * @param \DateTime $to
     */

...
Ext.define('Shopware.apps.Ticket', {
     ...
     * @array
     */
    models: [ 'List', 'Status', 'Submission', 'Types', 'Forms', 'FormField', 'Mapping', 'Customer', 'Locale', 'History' ],
    ...
    views: [
        ...
        'settings.Forms', 'ticket.NewWindow', 'settings.Locale', 'settings.AddLocale', 'ticket.EditWindow'
    ],

 ...
 *
 */
//{block name="backend/swag_test_cases/application"}
Ext.define('Shopware.apps.SwagTestCases', {

    /**
     * The name of the module. Used for internal purpose
     * @string
     */
    name:'Shopware.apps.SwagTestCases',
     ...
     * @string
     */
    loadPath:'{url controller="SwagTestCases" action=load}',

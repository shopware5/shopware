...
.logo .inner .commstore {
	background: url("{link file='backend/b2bessentials/_resources/images/customerspecificprices.jpg'}") no-repeat right center;
	padding-right: 485px;
	min-height: 212px;
}
...
<fieldset class="logo">
	...
	<div class="inner">
		<div class="commstore">
			...
			<p>
				<ul class="list">
					<li>Die Preis-Konfiguration für Artikel und Kundengruppen findet in den Artikel-Stammdaten statt</li>
					<li>In den Grundeinstellungen können Sie pauschale Kundengruppen-Rabatte definieren</li>
					<li>Durch die Kombination mit Preisgruppen, können Sie auch einfache Rabatt-Staffeln für Kundengruppen und Artikelgruppen definieren.</li>

...
Ext.define('Shopware.apps.NewsletterManager.view.newsletter.Designer', {
                        ...
                        Ext.each(els, function(element) {
                            ...
                            var specs = {
                                ...
                                children: [
                                    ...
                                    { tag: 'div', cls: 'x-emotion-element-inner', html: component.get('name') + isNew },
    ...
    addGridEvents: function() {
         ...
         *
         * TODO@stp - Build a better workaround to fix the issue.
         */
        Ext.defer(function() {
...
//                    if(record.get('xType') == 'newsletter-components-article' ||
//                       record.get('xType') == 'newsletter-components-article-slider') {
//                        elEndRow = startRow + 1;
//                    }

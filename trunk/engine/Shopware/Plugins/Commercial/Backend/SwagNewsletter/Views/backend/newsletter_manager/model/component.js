...
/**
 * Shopware Model - Premium Newsletter Manager backend module.
 */
...
Ext.define('Shopware.apps.NewsletterManager.model.Component', {
    ...
    associations: [
        { type: 'hasMany', model: 'Shopware.apps.NewsletterManager.model.Field', name: 'getComponentFields', associationKey: 'componentFields'}
    ]

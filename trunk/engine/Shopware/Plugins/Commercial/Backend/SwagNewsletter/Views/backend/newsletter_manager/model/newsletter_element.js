...
/**
 * Shopware Model - SwagNewsletter backend module.
 */
...
Ext.define('Shopware.apps.NewsletterManager.model.NewsletterElement', {
    ...
    associations: [
        { type: 'hasMany', model: 'Shopware.apps.NewsletterManager.model.Component', name: 'getComponent', associationKey: 'component'}
    ]

...
class Component extends ModelEntity
{
    ...
    /**
     * INVERSE SIDE
     * Contains all the assigned \Shopware\CustomModels\SwagNewsletter\Field models.
     ...
     *
     * @ORM\OneToMany(targetEntity="Shopware\CustomModels\SwagNewsletter\Field", mappedBy="component", orphanRemoval=true, cascade={"persist", "update"})
    ...
    {
        return $this->setOneToMany($fields, '\Shopware\CustomModels\SwagNewsletter\Field', 'fields', 'component');
    }

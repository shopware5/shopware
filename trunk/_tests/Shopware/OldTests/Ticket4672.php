 ...
 * @ticket 4672
 */
class Shopware_RegressionTests_Ticket4672 extends Enlight_Components_Test_Plugin_TestCase
{    
	/**
	...
	public function testNewsletterLog()
	{
		...
		if(!preg_match('#<img src="([^"]+)" style="width:1px;height:1px">#msi', $this->Response()->getBody(), $match)) {
			$this->fail();
		}

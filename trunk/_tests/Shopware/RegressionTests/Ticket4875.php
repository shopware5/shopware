 ...
 * @ticket 4875
 */
class Shopware_RegressionTests_Ticket4875 extends Enlight_Components_Test_Controller_TestCase
{    
    /**
	 * Test case method
	 */
	public function testLinkPlugin()
    {
        ...
        $this->markTestIncomplete("Shopware_RegressionTests_Ticket4875 marked as incomplete!");
        return;

 ...
 * @group Config
 */
class Shopware_IntegrationTests_Backend_ConfigMailTest extends Shopware_IntegrationTests_Backend_LoginTest
{ 
    /**
     * 
     */
    public function testBasicConfigMail()
    {
        // execute Login
        $this->login();
     ...
     */
    private function openConfigMail()
    {
        sleep(2);
        $this->open('backend?app=Mail');
        // Wait until default layer is loaded
        $this->waitForElementPresent('css=div[id^=mail-main-window]');
    }
}
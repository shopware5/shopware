...
EOT
    ...
    'requirements_error' => '<h3 class="alert-heading">Attention!</h3>Some system requirements have not been met.',
    'requirements_success'              => '<h3 class="alert-heading">Congratulation!</h3>All system requirements for a successful installation are met',
    'requirements_ioncube'              => '<strong>* Note:</strong> Auf Deinem System ist die Codierungs-Software ionCube nicht installiert. Diese wird nur benötigt, wenn Du Dir später über unseren <a href="https://store.shopware.com" target="_blank">Shopware Community Store</a> Erweiterungen installieren möchtest, die mit ionCube verschlüsselt sind. Du kannst die Installation von ionCube auch jederzeit nachholen.',
    ...
    'configuration_sconfig_text'            => 'It\'s almost done! Now you just have to define some basic settings for your shop before the installation is finished. Of course, everything you enter here can be changed later.',
